...
export default function AlertCenter() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        setAlerts(generateAlerts(cards));
      } catch (error) {
  ...
  const stats = useMemo(() => {
    const rises = alerts.filter((alert) => alert.type === "RISE").length;
    const drops = alerts.filter((alert) => alert.type === "DROP").length;
      ...
      <main className="min-h-screen bg-[#07090d] text-white">
        <div className="mx-auto w-full max-w-[1250px] px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div className="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base">
                  Surveille les mouvements importants de ton portefeuille et
                  identifie rapidement les cartes qui méritent ton attention.
                </p>
              </div>
          ...
          <section className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-green-500/10 bg-green-500/[0.035] p-4">
              <div className="flex items-center gap-3">
            ...
            <div className="rounded-2xl border border-red-500/10 bg-red-500/[0.035] p-4">
              <div className="flex items-center gap-3">
