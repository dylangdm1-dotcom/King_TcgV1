    ...
    <div className="mx-auto w-full max-w-[1250px] px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/[0.07] bg-gradient-to-br from-[#11151d] via-[#0d1118] to-[#090b10] p-6 shadow-2xl sm:p-8">
        ...
        <div className="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-100 sm:text-base">
      ...
      <section className="mt-5">
        <div className="mb-2.5 flex items-center gap-2 px-1">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-zinc-200">
            Notifications
          </p>
        </div>
            ...
            {alerts.map((alert, index) => {
              ...
              return (
                <article
                  ...
                  className="group relative overflow-hidden rounded-2xl border bg-[#151c25] p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-white/[0.14] hover:shadow-xl"
                  style={{
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-2 flex items-end gap-3">
                      <p className="min-w-0 flex-1 text-left text-sm leading-5 text-zinc-100">
                        {alert.message}
                      </p>
