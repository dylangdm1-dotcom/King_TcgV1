    ...
    <div className="mx-auto w-full max-w-6xl space-y-5 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <div className="kt-summary-tile rounded-[16px] bg-[#111923] p-3 sm:p-4">
          ...
          <div className="kt-summary-tile rounded-[16px] bg-emerald-400/[0.035] p-3 sm:p-4">
            <div className="flex flex-col items-center gap-1.5 text-center sm:flex-row sm:text-left">
          ...
          <div className="kt-summary-tile rounded-[16px] bg-rose-400/[0.025] p-3 sm:p-4">
            <div className="flex flex-col items-center gap-1.5 text-center sm:flex-row sm:text-left">
      ...
      {/* LÉGENDE COULEURS */}
      <section className="flex flex-wrap gap-x-4 gap-y-2 px-1 text-[9px] font-bold">
        <span className="inline-flex items-center gap-1.5 text-emerald-300"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />Hausse positive</span>
        <span className="inline-flex items-center gap-1.5 text-rose-300"><span className="h-1.5 w-1.5 rounded-full bg-rose-400" />Baisse / risque</span>
        <span className="inline-flex items-center gap-1.5 text-amber-300"><span className="h-1.5 w-1.5 rounded-full bg-amber-400" />Opportunité / surveillance</span>
        <span className="inline-flex items-center gap-1.5 text-cyan-300"><span className="h-1.5 w-1.5 rounded-full bg-cyan-400" />Information système</span>
      </section>

      {/* CONTENT */}
      <section>
        {loading ? (
          <div className="kt-empty-state rounded-2xl p-12 text-center">
          ...
          <div className="kt-empty-state rounded-2xl px-6 py-14 text-center">
