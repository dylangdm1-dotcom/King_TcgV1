...
const CHINESE_MARKET_OVERRIDES: Record<string, RegionalMarketIdentity> = {
  "sv8a:236": {
    setId: "CSV9C",
    number: "260",
    setName: "Stellar Crystal",
    cardmarketUrl:
      "https://www.cardmarket.com/fr/Pokemon/Products/Singles/Stellar-Crystal/Pikachu-ex-V4-CSV9C260?language=2",
    imageUrl:
      "https://pokecardex-scans.b-cdn.net/sets_chn/CSV9C/260.jpg?class=hd",
  },
};
