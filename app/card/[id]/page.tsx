...
export default function CardPage() {
  ...
  const openedFromScanner = searchParams.get("source") === "scanner";
  const rawParamId =
    ...
    <>
      ...
      <main className="kt-app-shell kt-card-detail-page pb-32 text-white selection:bg-cyan-500/20">
        ...
        <div className="kt-page-wrap relative space-y-4">
          ...
          {openedFromScanner ? (
            <div className="flex items-center gap-2 rounded-xl border border-emerald-400/15 bg-emerald-400/[0.05] px-3.5 py-2.5 text-[10px] font-bold text-emerald-200">
              <Zap className="h-3.5 w-3.5" />
              Carte validée par le Scanner · cotations synchronisées pour cette carte uniquement.
            </div>
          ) : null}
