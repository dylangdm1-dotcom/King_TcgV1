        ...
        <div className="relative mx-auto max-w-7xl space-y-5 px-4 py-5 sm:space-y-6 sm:px-6 sm:py-6 lg:px-8">
          ...
          <section className="kt-premium-card space-y-3 overflow-hidden p-3.5 sm:p-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="rounded-xl border border-white/[0.08] bg-[#1a222c] p-2.5 flex flex-col justify-between min-h-[72px]">
              ...
              <div className="rounded-xl border border-white/[0.08] bg-[#1a222c] p-2.5 flex flex-col justify-between min-h-[72px]">
                ...
                <span className="mt-1 text-[10px] font-bold leading-snug text-white">
                  {recommendation}
                </span>
              </div>
            </div>
