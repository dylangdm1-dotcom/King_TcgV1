    ...
    <>
      ...
      <main className="kt-app-shell pb-32 text-white selection:bg-cyan-500/20">
        ...
        <div className="relative mx-auto max-w-7xl space-y-5 px-4 py-5 sm:space-y-6 sm:px-6 sm:py-6 lg:px-8">
          ...
          <section className="kt-premium-card kt-rise-in overflow-hidden p-5 sm:p-7 lg:p-8">
          ...
          <section className="kt-premium-card space-y-5 overflow-hidden p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/[0.08] bg-[#1a222c] p-4 sm:p-5 flex flex-col justify-between min-h-[105px]">
          ...
          <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
            <section className="kt-premium-card p-5 sm:p-6">
              ...
              <div className="overflow-hidden rounded-2xl border border-white/[0.07] bg-[#151c25] p-3">
