    ...
    <>
      ...
      <main className="kt-app-shell pb-32 text-white selection:bg-cyan-500/20">
        ...
        <div className="relative mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          <section className="kt-premium-card kt-rise-in p-5 sm:p-7 lg:p-9">
          ...
          <section className="rounded-2xl border border-cyan-400/12 bg-cyan-400/[0.035] px-4 py-3.5 sm:px-5">
            <p className="text-[11px] font-medium leading-5 text-zinc-400">
              <span className="font-black text-cyan-300">Comprendre cette fiche :</span>{" "}
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="kt-premium-card p-5 sm:p-6">
              <MarketPanel
          ...
          <section className="kt-premium-card space-y-5 p-5 sm:p-6">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              <div className="rounded-2xl border border-white/[0.07] bg-white/[0.025] p-4 sm:p-5 flex flex-col justify-between min-h-[105px]">
          ...
          <div className="grid grid-cols-1 gap-6">
            <section className="kt-premium-card p-5 sm:p-6">
              <div className="mb-4">
                ...
                <p className="mt-1 text-[11px] font-medium leading-5 text-zinc-500">
                  Évolution enregistrée sur cet appareil au fil des consultations de la carte.
                </p>
              </div>
              <div className="overflow-hidden rounded-2xl border border-white/[0.06] bg-black/30 p-3">
