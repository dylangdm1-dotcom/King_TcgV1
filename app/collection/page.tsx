    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen text-white px-4 sm:px-8 py-6 pb-28">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            <h1 className="text-xl sm:text-xl font-black uppercase tracking-tight text-white">
          ...
          <section className="grid grid-cols-2 gap-2.5 lg:grid-cols-4">
            ...
            <div className="kt-premium-panel kt-premium-card-lift rounded-[17px] p-3 sm:p-3.5 flex flex-col justify-between min-h-[94px]">
              ...
              <div className="mt-2">
                {topValuedCard ? (
                  <div className="flex items-baseline justify-between gap-2">
                    <span className="text-xs font-black text-white truncate max-w-[105px]">
                      {topValuedCard.name}
                    </span>
