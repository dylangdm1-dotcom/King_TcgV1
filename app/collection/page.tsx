          ...
          <section className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] leading-5 text-zinc-100">Les valeurs sont calculées à partir des prix marché disponibles. Ajoutez vos quantités pour suivre votre exposition réelle.</p>
              </div>
            </div>
          </section>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            ...
            <div className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
              ...
              {extensionProgress.length ? (
                ...
                <div className="flex min-h-[140px] items-center justify-center rounded-2xl border border-white/[0.07] bg-[#171d25] p-6 text-center text-[11px] text-zinc-200">
