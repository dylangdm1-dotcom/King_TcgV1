    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen text-white px-4 sm:px-8 py-6 pb-28">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            <h1 className="text-xl sm:text-lg font-black uppercase tracking-tight text-white">
          ...
          <section className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-black uppercase tracking-[0.16em] text-white">Collection TCG</p>
          ...
          <section className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <div className="kt-premium-panel kt-premium-card-lift rounded-[15px] p-2 sm:p-3 flex flex-col justify-between min-h-[82px]">
              <div className="flex justify-between items-start">
                <span className="text-zinc-500 text-[10px] sm:text-[10px] font-bold uppercase tracking-[0.11em] flex items-center gap-1 min-w-0 whitespace-nowrap">
            ...
            <div className="kt-premium-panel kt-premium-card-lift rounded-[15px] p-2 sm:p-3 flex flex-col justify-between min-h-[82px]">
              <div className="flex justify-between items-start">
                ...
                <span className="text-[10px] sm:text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-400 bg-zinc-800/40 border border-zinc-800 px-2 py-0.5 rounded-full">
                  Stock
                </span>
              </div>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
              <div className="mb-4 flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-[10px] leading-4 text-zinc-500">Suivez vos cartes, leur valeur et la composition de votre collection, doublons inclus.</p>
                </div>
              </div>
            ...
            <div className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
              ...
              {extensionProgress.length ? (
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 text-[10px] font-semibold text-zinc-500">{extension.ownedCount} / {extension.total} · {extension.missing} manquante{extension.missing > 1 ? "s" : ""}</p>
                        </div>
                ...
                <div className="flex min-h-[140px] items-center justify-center rounded-2xl border border-white/[0.07] bg-[#171d25] p-6 text-center text-[11px] text-zinc-500">
          ...
          <section className="space-y-4 pt-2">
            ...
            {loading ? (
              ...
              <div className="kt-premium-panel rounded-[18px] p-10 text-center text-xs text-zinc-400 font-medium">
