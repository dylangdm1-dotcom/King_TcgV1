          ...
          <section className="space-y-3">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex items-center gap-2">
                <button type="button" onClick={() => setViewMode("compact")} title="Vue compacte 3×3" className={`rounded-xl border p-3 transition ${viewMode === "compact" ? "border-cyan-400/40 bg-cyan-400/10 text-cyan-300" : "border-white/[0.08] bg-[#171e28]/80 text-zinc-200"}`}>
                  <LayoutGrid className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => setViewMode("large")} title="Vue détaillée" className={`rounded-xl border p-3 transition ${viewMode === "large" ? "border-cyan-400/40 bg-cyan-400/10 text-cyan-300" : "border-white/[0.08] bg-[#171e28]/80 text-zinc-200"}`}>
