        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          {!loading && cards.length > 0 && (
            <section className="grid gap-3 grid-cols-3">
              <div className="rounded-2xl border border-white/[0.08] bg-[#171e28]/80 p-4 shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/[0.08] bg-[#171e28]/80 pl-11 pr-10 py-3 text-xs outline-none focus:border-cyan-500/50"
                />
                {search && (
                  <button
                    onClick={() => setSearch("")}
              ...
              <div className="flex items-center gap-2">
                <button type="button" onClick={() => setViewMode("compact")} title="Vue compacte 3×3" className={`rounded-xl border p-3 transition ${viewMode === "compact" ? "border-cyan-400/40 bg-cyan-400/10 text-cyan-300" : "border-white/[0.08] bg-[#171e28]/80 text-zinc-500"}`}>
                  <LayoutGrid className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => setViewMode("large")} title="Vue détaillée" className={`rounded-xl border p-3 transition ${viewMode === "large" ? "border-cyan-400/40 bg-cyan-400/10 text-cyan-300" : "border-white/[0.08] bg-[#171e28]/80 text-zinc-500"}`}>
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1 sm:w-52">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-2xl border border-white/[0.08] bg-[#171e28]/80 pl-9 py-3 text-xs font-bold"
                  >
          ...
          {loading ? (
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              {Array.from({ length: 12 }).map((_, i) => (
                <div
                  key={i}
                  className="aspect-[0.72] animate-pulse rounded-2xl bg-[#171e28]/80 border border-white/[0.08]"
                />
              ))}
            </div>
          ) : processedCards.length === 0 ? (
            <div className="rounded-2xl border border-white/[0.08] bg-[#171e28]/80 p-12 text-center">
