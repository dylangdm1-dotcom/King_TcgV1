        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          {!loading && cards.length > 0 && (
            <section className="grid gap-3 grid-cols-3">
              <div className="rounded-[16px] border border-cyan-400/12 bg-[#0a1118] p-4 shadow-[0_14px_34px_rgba(0,0,0,.20)]">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-[15px] border border-cyan-400/16 bg-[#0a1118] py-3 pl-11 pr-10 text-xs text-white outline-none transition placeholder:text-zinc-500 focus:border-cyan-300/45"
                />
                {search && (
                  <button
                    onClick={() => setSearch("")}
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1 sm:w-52">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-[15px] border border-cyan-400/14 bg-[#0a1118] py-3 pl-9 pr-8 text-xs font-bold text-white outline-none focus:border-cyan-300/40"
                  >
