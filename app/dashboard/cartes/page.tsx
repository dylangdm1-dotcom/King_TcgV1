        ...
        <div className="kt-page-wrap space-y-5">
          <section className="kt-page-header kt-hero-surface overflow-hidden border">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2.5 border-t border-white/[0.06] pt-4">
              ...
              <div className="kt-subpanel p-3"><p className="text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-200">Investissement</p><p className="mt-1 text-sm font-black text-zinc-200">{euro(totals.buy)} €</p></div>
