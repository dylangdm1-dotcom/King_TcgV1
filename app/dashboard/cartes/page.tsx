        ...
        <div className="kt-page max-w-4xl space-y-5">
          <section className="overflow-hidden rounded-[24px] border border-sky-300/20 bg-[linear-gradient(145deg,rgba(14,165,233,.10),rgba(20,27,36,.96)_45%,rgba(17,24,33,.98))] p-5 shadow-[0_24px_70px_rgba(2,132,199,.10)] sm:p-6">
            ...
            <div className="mt-5 grid grid-cols-3 gap-2.5 border-t border-white/[0.08] pt-4">
              ...
              <div className="kt-premium-card-soft p-3"><p className="text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-500">Investi</p><p className="mt-1 text-sm font-black text-zinc-200">{euro(totals.buy)} €</p></div>
              <div className="kt-premium-card-soft p-3"><p className="text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-500">Plus-value</p><p className={`mt-1 text-sm font-black ${totals.value - totals.buy >= 0 ? "text-emerald-200" : "text-rose-300"}`}>{totals.value - totals.buy >= 0 ? "+" : ""}{euro(totals.value - totals.buy)} €</p></div>
            </div>
          </section>
                ...
                return (
                  <article key={card.id} className="rounded-[18px] border border-sky-300/10 bg-[#171f29] p-3 shadow-[0_14px_34px_rgba(0,0,0,.18)] transition hover:border-sky-300/20">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 truncate text-[10px] font-semibold text-zinc-500">{card.set?.name} · #{card.number}</p>
                          </div>
                    ...
                    <div className="mt-1 flex items-center justify-between rounded-xl border border-white/[0.07] bg-[#1a222c] px-3 py-2">
                      <span className="flex items-center gap-1.5 text-[10px] font-black text-zinc-400">{performance >= 0 ? <TrendingUp className="h-3.5 w-3.5 text-emerald-200" /> : <TrendingDown className="h-3.5 w-3.5 text-rose-300" />} Rendement {performance >= 0 ? "+" : ""}{performance.toFixed(1)}%</span>
