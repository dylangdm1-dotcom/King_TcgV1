          ...
          <section className="overflow-hidden rounded-[24px] border border-sky-300/20 bg-[linear-gradient(145deg,rgba(14,165,233,.10),rgba(20,27,36,.96)_45%,rgba(17,24,33,.98))] p-5 shadow-[0_24px_70px_rgba(2,132,199,.10)] sm:p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h1 className="text-[22px] font-black tracking-tight text-white sm:text-[26px]">Détail du portefeuille</h1>
                <p className="mt-1 max-w-2xl text-[11px] leading-5 text-zinc-100">Retrouvez toutes les cartes prises en compte dans votre portefeuille : prix d’achat, valeurs actuelles, états et plus-values.</p>
              </div>
              ...
              {visibleCards.map((card) => {
                ...
                return (
                  <article key={card.id} className="rounded-[18px] border border-sky-300/10 bg-[#171f29] p-3 shadow-[0_14px_34px_rgba(0,0,0,.18)] transition hover:border-sky-300/20">
                    ...
                    <div className="mt-1 flex items-center justify-between rounded-xl border border-white/[0.055] bg-[#1a222c] px-3 py-2">
