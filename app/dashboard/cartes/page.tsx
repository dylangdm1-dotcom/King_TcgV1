                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="mt-1 truncate text-[9px] font-semibold text-zinc-500">{card.set?.name} · #{card.number}</p>
                          </div>
                          <div className="flex max-w-[58%] flex-wrap items-center justify-end gap-1">
                            <span className="rounded-lg border border-white/[0.09] bg-white/[0.04] px-1.5 py-1 text-[7px] font-black text-zinc-300">{card.condition}</span>
                            {card.rarity ? <span className="max-w-[86px] truncate rounded-lg border border-violet-200/15 bg-violet-300/[0.07] px-1.5 py-1 text-[7px] font-black text-violet-200">{card.rarity}</span> : null}
                            <span className="rounded-lg border border-amber-200/15 bg-amber-300/[0.07] px-1.5 py-1 text-[7px] font-black text-amber-200">x{card.quantity}</span>
                          </div>
                        </div>
