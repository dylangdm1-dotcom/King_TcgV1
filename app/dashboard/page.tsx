          ...
          <div className="space-y-4 pt-2">
            ...
            <section className="kt-premium-card overflow-hidden rounded-[22px] p-4 sm:p-5 lg:p-6">
              <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="self-start rounded-xl border border-emerald-300/15 bg-emerald-300/[0.06] px-3 py-2 text-right sm:self-auto">
                  <p className="text-[8px] font-black uppercase tracking-widest text-emerald-200/60">
                    Modèle
                  </p>
