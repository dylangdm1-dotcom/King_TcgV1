...
function SevenDayChart({
  ...
  if (!values.length) {
    return (
      <div className="flex h-56 items-center justify-center text-[11px] font-bold text-zinc-500">
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-[#121923] px-2 pt-3 shadow-inner sm:px-4">
    ...
    <>
      ...
      <main className="kt-app-shell pb-32 selection:bg-cyan-500/20">
        <div className="kt-page max-w-xl space-y-5">
          ...
          <section className="kt-premium-card rounded-[22px] p-4 sm:p-5">
            <div className="mb-4 flex items-start justify-between gap-3">
              ...
              <Link href="/collection/tout" className="shrink-0 text-[9px] font-black uppercase tracking-wider text-amber-300 hover:text-white">Détails</Link>
            </div>
