...
function SevenDayChart({ values }: { values: number[] }) {
  ...
  return (
    <div className="overflow-hidden rounded-[18px] border border-white/[0.1] bg-[#151c25] shadow-[0_18px_45px_rgba(0,0,0,.24)]">
      <div className="grid grid-cols-3 border-b border-white/[0.055] bg-[#1a222d]">
        <div className="p-3.5">
          ...
          <section className="grid grid-cols-2 gap-2.5 lg:grid-cols-4">
            ...
            <div className="relative flex min-h-[88px] flex-col justify-between overflow-hidden rounded-[16px] border border-cyan-400/14 bg-[#0a1118] p-3.5 shadow-[0_14px_34px_rgba(0,0,0,.20)] transition hover:border-cyan-300/28">
              ...
              <div className="text-base font-black text-white tabular-nums mt-1">
                ...
                <span className="text-[10px] text-zinc-200 font-bold uppercase">
                  {" "}
                  / 10
                </span>
              </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            <section className="overflow-hidden rounded-[20px] border border-cyan-400/14 bg-[#0a1118] p-4 shadow-[0_18px_44px_rgba(0,0,0,.22)] sm:p-5 lg:p-6">
              ...
              stats.current >
                ...
                <div className="h-56 flex items-center justify-center rounded-2xl border border-white/[0.06] bg-black/40">
            ...
            <section className="rounded-[18px] border border-white/[0.09] bg-[#0a1118] p-4 shadow-[0_16px_38px_rgba(0,0,0,.20)]">
              ...
              <p className="text-[11px] font-bold text-zinc-200 py-1 italic">
                {cards.length
                  ? `${cards.length} carte${
                      cards.length >
                      1
