          ...
          ids.map(
            async (
              ...
              try {
                ...
                const lastTrackedPrice = getLastPrice(card)?.average || 0;
                ...
                const score = getInvestmentScore(
                  card,
                  getEffectiveMarketHistory(card),
                  condition
                );
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] text-zinc-200">Tendances Pokémon, extensions et répartition de votre collection.</p>
                </div>
              </div>
