        ...
        <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          {!loading && cards.length > 0 && (
            <section className="grid gap-3 grid-cols-2 lg:grid-cols-3">
              <div className="rounded-2xl border border-white/[0.08] bg-[#171e28]/80 p-4 sm:p-5 flex flex-col justify-between min-h-[95px] shadow-xl">
              ...
              <div className="hidden lg:flex rounded-2xl border border-white/[0.08] bg-[#171e28]/80 p-4 sm:p-5 flex-col justify-between min-h-[95px] shadow-xl">
                <span className="text-zinc-500 text-[10px] font-black uppercase tracking-wider flex items-center gap-1.5">
