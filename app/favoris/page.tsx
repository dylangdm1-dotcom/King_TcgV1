          ...
          {!loading && cards.length > 0 && (
            <section className="grid gap-2">
              <div className="flex items-center justify-between rounded-xl border border-white/[0.08] bg-[#171e28]/80 px-3 py-2">
                <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-400"><Bookmark className="h-3.5 w-3.5 text-yellow-400" /> Cartes favorites</span>
                <span className="text-sm font-black text-white">{cards.length}</span>
              </div>
              <div className="flex items-center justify-between rounded-xl border border-white/[0.08] bg-[#171e28]/80 px-3 py-2">
                <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-400"><Activity className="h-3.5 w-3.5 text-emerald-400" /> Suivez rapidement les cartes que vous avez mises en favoris.</span>
