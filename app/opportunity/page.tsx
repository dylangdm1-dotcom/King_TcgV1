      ...
      <>
        ...
        <main className="kt-premium-shell min-h-screen pb-24 text-white">
          <div className="mx-auto w-full max-w-7xl space-y-5 px-4 py-5 sm:px-6 lg:px-8">
            ...
            <section className="rounded-2xl border border-white/[0.055] bg-[#151c25] p-5">
        ...
        <div className="mx-auto w-full max-w-7xl space-y-6 px-4 py-5 sm:px-6 sm:py-6 lg:px-8">
          ...
          <section className="kt-hero-surface relative overflow-hidden rounded-[22px] border p-5 sm:p-6">
            ...
            <div className="relative">
              ...
              <h1 className="mt-3 flex items-center gap-3 text-[22px] font-black tracking-tight text-white sm:text-[26px]">
          ...
          <section className="flex flex-wrap gap-x-4 gap-y-2 px-1 text-[9px] font-bold">
            <span className="inline-flex items-center gap-1.5 text-emerald-300"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400" />Achat / potentiel positif</span>
            <span className="inline-flex items-center gap-1.5 text-amber-300"><span className="h-1.5 w-1.5 rounded-full bg-amber-400" />Sous observation</span>
            <span className="inline-flex items-center gap-1.5 text-rose-300"><span className="h-1.5 w-1.5 rounded-full bg-rose-400" />Vente / risque</span>
            <span className="inline-flex items-center gap-1.5 text-cyan-300"><span className="h-1.5 w-1.5 rounded-full bg-cyan-400" />Information marché</span>
          </section>
          ...
          <section className="space-y-3">
            ...
            {alerts.length === 0 ? (
              <div className="rounded-2xl border border-white/[0.055] bg-white/[0.025] p-5">
          ...
          <div className="space-y-7">
            ...
            {opportunities.length === 0 && (
              <section className="kt-empty-state rounded-2xl px-5 py-12 text-center">
