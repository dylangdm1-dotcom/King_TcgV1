      ...
      <main className="kt-premium-shell min-h-screen pb-28 text-white selection:bg-cyan-500/10">
        <div className="kt-page-wrap space-y-5">
          ...
          <section className="grid grid-cols-2 gap-2 text-[9px] font-bold">
            <span className="flex min-h-9 items-center justify-center gap-2 rounded-xl border border-cyan-300/22 bg-cyan-400/[0.06] px-2.5 text-center text-cyan-200"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300" />Achat · potentiel positif</span>
            <span className="flex min-h-9 items-center justify-center gap-2 rounded-xl border border-cyan-300/22 bg-cyan-400/[0.06] px-2.5 text-center text-cyan-200"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300" />Sous observation</span>
            <span className="flex min-h-9 items-center justify-center gap-2 rounded-xl border border-cyan-300/22 bg-cyan-400/[0.06] px-2.5 text-center text-cyan-200"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300" />Vente · risque</span>
            <span className="flex min-h-9 items-center justify-center gap-2 rounded-xl border border-cyan-300/22 bg-cyan-400/[0.06] px-2.5 text-center text-cyan-200"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-300" />Information marché</span>
          </section>
