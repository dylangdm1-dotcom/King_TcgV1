      ...
      <main className="kt-premium-shell min-h-screen pb-28 text-white selection:bg-cyan-500/10">
        <div className="kt-page-wrap space-y-5">
          ...
          <section className="grid grid-cols-2 gap-2 text-[9px] font-bold">
            <span className="flex min-h-9 items-center gap-2 rounded-xl border border-emerald-300/18 bg-emerald-400/[0.055] px-2.5 text-emerald-300"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-emerald-400" />Achat · potentiel positif</span>
            <span className="flex min-h-9 items-center gap-2 rounded-xl border border-amber-300/18 bg-amber-400/[0.055] px-2.5 text-amber-300"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-amber-400" />Sous observation</span>
            <span className="flex min-h-9 items-center gap-2 rounded-xl border border-rose-300/18 bg-rose-400/[0.055] px-2.5 text-rose-300"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-rose-400" />Vente · risque</span>
            <span className="flex min-h-9 items-center gap-2 rounded-xl border border-cyan-300/18 bg-cyan-400/[0.055] px-2.5 text-cyan-300"><span className="h-1.5 w-1.5 shrink-0 rounded-full bg-cyan-400" />Information marché</span>
          </section>
