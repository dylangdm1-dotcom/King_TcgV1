      ...
      <main className="kt-app-shell pb-32">
        ...
        <section className="relative overflow-hidden border-b border-cyan-400/[0.08] px-4 py-12 text-center sm:py-16">
          ...
          <div className="relative z-10 mx-auto max-w-xl space-y-4 kt-rise-in">
            ...
            <h1 className="flex items-center justify-center gap-3 text-4xl font-black tracking-[-0.045em] text-white sm:text-6xl">
              <Crown className="h-8 w-8 text-cyan-300 drop-shadow-[0_0_12px_rgba(34,211,238,.35)] sm:h-11 sm:w-11" />
              <span className="-skew-x-3">King<span className="text-cyan-400">_TCG</span></span>
            </h1>
            ...
            <div className="kt-premium-card kt-interactive-card rounded-[18px] p-5">
              <div className="flex items-center gap-2.5 mb-2">
                <div className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl border border-white/15 bg-white p-1">
                  <img src="/brands/whatnot.svg" alt="Whatnot" className="h-full w-full object-contain" />
                </div>
                <h3 className="font-bold text-white text-sm uppercase tracking-wide">
...
function Stat({
  ...
  return (
    <div className="kt-premium-card kt-interactive-card flex min-h-[78px] flex-col justify-between rounded-[16px] p-3">
      ...
      <div className={`kt-stat-value mt-2 text-lg font-black ${title === "Valeur estimée" ? "text-emerald-300" : ""}`}>
        {value}
      </div>
    </div>
  );
