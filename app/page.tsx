        ...
        <section className="relative overflow-hidden border-b border-cyan-400/[0.08] px-4 py-12 text-center sm:py-16">
          ...
          <div className="relative z-10 mx-auto max-w-xl space-y-4 kt-rise-in">
            ...
            <h1 className="flex items-center justify-center gap-3 text-4xl font-black tracking-[-0.045em] text-white sm:text-6xl">
              <img src="/brands/king-tcg-crown.png" alt="" className="h-9 w-9 object-contain drop-shadow-[0_0_12px_rgba(34,211,238,.28)] sm:h-12 sm:w-12" />
        ...
        <section className="mx-auto max-w-xl space-y-4 px-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <QuickCard
              ...
              icon={<img src="/brands/psa.png" alt="PSA" className="h-6 w-10 rounded-md object-contain" />}
              isSpecial={true}
            />
          </div>
