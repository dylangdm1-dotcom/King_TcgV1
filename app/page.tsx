              ...
              <div className="overflow-hidden">
                <div className="border-t border-cyan-300/[0.13] px-5 py-7 text-center sm:px-8 sm:py-9">
                  <div className="mx-auto flex max-w-3xl flex-col items-center">
                    <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-amber-300/35 bg-gradient-to-br from-cyan-300/[0.10] via-[#11191d] to-amber-300/[0.10] p-2 shadow-[0_0_30px_rgba(34,211,238,.11),0_0_22px_rgba(251,191,36,.07)] sm:h-28 sm:w-28">
                      <img
                        src="/brands/whatnot.png"
                        alt="Icône Dylang_TCG sur Whatnot"
                    ...
                    <section className="w-full text-center">
                      ...
                      <div className="mx-auto mt-3 max-w-2xl space-y-3 text-[11px] leading-[1.8] text-zinc-300 sm:text-[12px]">
                        <p>
                          Collectionneur et passionné de Pokémon, j’ai créé King_TCG avec l’envie de réunir dans une seule application les outils que j’aurais aimé avoir pour gérer ma propre collection.
                        </p>
                        <p>
                          King_TCG évolue autour des besoins réels des collectionneurs, des tests et des retours de sa communauté.
                        </p>
                      </div>
                    </section>
                    ...
                    <section className="w-full text-center">
                      <h3 className="flex items-center justify-center gap-2 text-[12px] font-black text-white sm:text-[13px]">
                        <Video className="h-4 w-4 shrink-0 text-cyan-300" />
                        Dylang_TCG sur Whatnot
                      </h3>
                      <p className="mx-auto mt-3 max-w-2xl text-[11px] leading-[1.8] text-zinc-300 sm:text-[12px]">
                        Retrouvez-moi en live autour de Pokémon : ouvertures, cartes, échanges et moments avec la communauté.
                      </p>
                    ...
                    <section className="w-full text-center">
                      ...
                      <div className="mx-auto mt-3 max-w-2xl space-y-2 text-[11px] leading-[1.8] text-zinc-300 sm:text-[12px]">
                        <p>Vous aimez King_TCG et souhaitez participer à son développement ?</p>
                        <p>Vous pouvez soutenir librement le projet et contribuer à son évolution.</p>
                      </div>
                      <button
                        type="button"
                        disabled
