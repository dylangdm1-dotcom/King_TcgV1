...
function FeatureRow({ children, premium = false }: { children: React.ReactNode; premium?: boolean }) {
  return (
    <li className="flex items-start gap-2.5 text-[10px] leading-4 text-zinc-100">
    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
          <Link href="/parametres" className="kt-premium-button-secondary inline-flex items-center gap-2 px-3.5 py-2 text-[10px] uppercase tracking-wider">
          ...
          <section className="kt-premium-panel relative overflow-hidden rounded-[26px] p-5 sm:p-7">
            ...
            <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[18px] border border-cyan-300/20 bg-cyan-400/[0.08] text-cyan-300">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-bold text-zinc-100">Gérez votre profil, vos quotas et votre abonnement King_TCG.</p>
                </div>
              </div>
            ...
            <div className="kt-premium-panel rounded-[24px] p-5 sm:p-6">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-black uppercase tracking-[0.14em] text-emerald-300">Compte Normal</p>
                    <h2 className="mt-1 text-lg font-black text-white">0 € / mois</h2>
                  </div>
                </div>
                <span className="rounded-full border border-emerald-400/15 bg-emerald-400/[0.06] px-2.5 py-1 text-[10px] font-black uppercase text-emerald-300">Gratuit</span>
              </div>

              <p className="mt-4 text-[11px] leading-5 text-zinc-200">
              ...
              <div className="mt-4 rounded-[18px] border border-emerald-400/10 bg-emerald-400/[0.03] p-3">
                <p className="text-[10px] font-black uppercase tracking-[0.12em] text-emerald-300">Quota scanner</p>
                <p className="mt-1 text-sm font-black text-white">30 scans / mois</p>
                <p className="mt-1 text-[10px] text-zinc-200">Quota global du compte Normal.</p>
              </div>
              ...
              <div className="relative">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.14em] text-cyan-300">Compte Premium</p>
                      <div className="mt-1 flex items-end gap-1.5">
                        <h2 className="text-lg font-black text-white">4,99 €</h2>
                        <span className="pb-0.5 text-[10px] font-bold text-zinc-200">/ mois</span>
                      </div>
                    </div>
                  </div>
                  <span className="rounded-full border border-cyan-400/15 bg-cyan-400/[0.06] px-2.5 py-1 text-[10px] font-black uppercase text-cyan-300">Premium</span>
                </div>
                ...
                <div className="mt-4 rounded-[18px] border border-cyan-400/12 bg-cyan-400/[0.04] p-3">
                  <p className="text-[10px] font-black uppercase tracking-[0.12em] text-cyan-300">Quota scanner global</p>
                  <p className="mt-1 text-sm font-black text-white">500 scans / mois</p>
                  <p className="mt-1 text-[10px] leading-4 text-zinc-200">Un seul quota partagé entre Mono, Batch et Quad.</p>
                </div>
          ...
          <section className="kt-premium-panel rounded-[24px] p-5 sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-[0.14em] text-cyan-300">Abonnement Premium</p>
                <h2 className="mt-1 text-base font-black text-white">Plus d’analyse, plus de scans</h2>
                <p className="mt-2 max-w-3xl text-[11px] leading-5 text-zinc-200">
