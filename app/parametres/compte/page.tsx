        ...
        <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
          ...
          <header className="relative overflow-hidden rounded-[22px] border border-cyan-400/30 bg-[#0a1118] p-5 shadow-[0_18px_48px_rgba(0,0,0,.24),0_0_34px_rgba(34,211,238,.05)] sm:p-6">
            ...
            <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-cyan-400/20 bg-cyan-400/[0.06] px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.12em] text-cyan-300">
          ...
          <section>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <article className="relative overflow-hidden rounded-[20px] border-2 border-cyan-400/75 bg-[#0d141c] p-5 shadow-[0_20px_60px_rgba(0,0,0,.28),0_0_30px_rgba(34,211,238,.055)] sm:p-6">
                ...
                <div className="relative">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <span className="flex h-11 w-11 items-center justify-center rounded-2xl border border-cyan-400/25 bg-cyan-400/[0.08] text-cyan-300">
                      ...
                      <div>
                        ...
                        <h3 className="mt-1 text-xl font-black text-white">Gratuit</h3>
                      </div>
                    </div>
                    <span className="rounded-full border border-cyan-400/25 bg-cyan-400/[0.07] px-3 py-1 text-[10px] font-black text-cyan-300">
                      0 € / mois
                    </span>
                  </div>

                  <p className="mt-4 text-[12px] leading-5 text-zinc-200">
                    Les fonctions essentielles de King_TCG pour gérer votre collection au quotidien.
                  </p>

                  <div className="mt-4 rounded-[14px] border border-cyan-400/20 bg-cyan-400/[0.055] px-4 py-3">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.08em] text-cyan-300">
                          Scanner Mono
                        </p>
                        <p className="mt-1 text-[11px] text-zinc-300">Quota mensuel inclus</p>
                      </div>
                  ...
                  <div className="mt-5 rounded-[14px] border border-white/[0.08] bg-white/[0.025] px-4 py-3 text-center text-[11px] font-black text-zinc-300">
                    Formule actuelle
                  </div>
                </div>
              </article>
          ...
          <section className="rounded-[20px] border border-cyan-400/22 bg-[#0a1118] p-5 shadow-[0_18px_48px_rgba(0,0,0,.22)] sm:p-6">
