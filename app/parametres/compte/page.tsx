      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
            ...
            <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-bold text-zinc-400">Gérez votre profil, vos quotas et votre abonnement King_TCG.</p>
                </div>
              </div>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="kt-premium-panel rounded-[24px] p-5 sm:p-6">
              ...
              <div className="mt-4 rounded-[18px] border border-emerald-400/10 bg-emerald-400/[0.03] p-3">
                ...
                <p className="mt-1 text-[10px] text-zinc-500">Quota global du compte Normal.</p>
              </div>
            ...
            <div className="kt-premium-panel relative overflow-hidden rounded-[24px] border-cyan-400/20 p-5 sm:p-6">
              ...
              <div className="relative">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-end gap-1.5">
                        ...
                        <span className="pb-0.5 text-[10px] font-bold text-zinc-500">/ mois</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mt-4 rounded-[18px] border border-cyan-400/12 bg-cyan-400/[0.04] p-3">
                  ...
                  <p className="mt-1 text-[10px] leading-4 text-zinc-500">Un seul quota partagé entre Mono, Batch et Quad.</p>
                </div>
          ...
          <footer className="border-t border-white/[0.06] pt-6 text-center">
            ...
            <p className="mt-1 text-[10px] font-bold text-zinc-500">Pokémon Trading Card Companion</p>
          </footer>
        </div>
      </main>
    </>
