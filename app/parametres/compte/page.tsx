    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-6 px-4 py-6 sm:px-6">
          ...
          <header className="kt-hero-surface relative overflow-hidden rounded-[22px] border p-5 sm:p-6">
          ...
          <section>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <article className="kt-plan-card kt-plan-normal relative overflow-hidden rounded-[20px] border p-5 sm:p-6">
                  ...
                  <div className="kt-feature-list overflow-hidden rounded-[16px] bg-black/15">
                    {normalFeatures.map((feature, index) => (
                      ...
                      >
                        ...
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-cyan-400/[0.07] text-cyan-300">
              ...
              <article className="kt-plan-card kt-plan-premium relative overflow-hidden rounded-[20px] border p-5 sm:p-6">
