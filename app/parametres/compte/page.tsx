...
function NormalFeatureRow({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex items-start gap-2.5 text-[11px] leading-5 text-zinc-100">
      <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full border border-emerald-400/20 bg-emerald-400/[0.07] text-emerald-300">
    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-7 px-4 py-6 sm:px-6">
          ...
          <header className="flex flex-col gap-4 rounded-[18px] border border-cyan-400/20 bg-[#0b1219] p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
            ...
            <button
              type="button"
              className="inline-flex w-full items-center justify-center gap-2 rounded-[13px] border border-cyan-400/40 bg-[#0d1821] px-4 py-2.5 text-[11px] font-black text-white shadow-[0_0_24px_rgba(34,211,238,.06)] transition hover:border-cyan-300/60 hover:bg-[#10202b] sm:w-auto"
            >
          ...
          <section>
            ...
            <div className="rounded-[18px] border border-cyan-400/40 bg-[#0d141c] p-5 sm:p-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="rounded-[14px] border border-cyan-400/25 bg-cyan-400/[0.06] px-4 py-2.5 text-center">
          ...
          <div className="rounded-[22px] border border-[#f5c451]/50 bg-[#0b1016] p-3 shadow-[0_0_36px_rgba(245,196,81,.05)] sm:p-4">
