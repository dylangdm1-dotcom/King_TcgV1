      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-7 px-4 py-6 sm:px-6">
          ...
          <header className="flex flex-col gap-4 border-b border-white/[0.08] pb-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              type="button"
              className="inline-flex w-full items-center justify-center gap-2 rounded-[13px] border border-white/[0.11] bg-[#151c25] px-4 py-2.5 text-[11px] font-black text-white transition hover:border-cyan-300/25 sm:w-auto"
            >
