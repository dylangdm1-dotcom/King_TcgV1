...
import { BookOpenCheck, ChevronRight, Database, FileText, Scale, ShieldCheck, Users } from "lucide-react";
...
const items = [
  ...
  {
    href: "/parametres/legal/mentions",
    title: "Mentions légales",
    description: "Éditeur, hébergement, propriété intellectuelle et informations administratives à compléter.",
    icon: BookOpenCheck,
  },
  {
    href: "/parametres/legal/droits",
    title: "Vos données & vos droits",
    description: "Accès, rectification, effacement, opposition et futur parcours de gestion du compte.",
    icon: Users,
  },
  {
    href: "/parametres/legal/sources",
    title: "Sources, services & licences",
    description: "Fournisseurs de données, services tiers et vérifications de licences avant production.",
    icon: Database,
  },
];
