            ...
            <div className="relative flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-3 max-w-2xl text-[11px] leading-5 text-zinc-200">
                  Personnalisez l’expérience King_TCG et retrouvez les informations, données et réglages de l’application.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="kt-premium-panel rounded-[18px] p-4 sm:p-5">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.12em] text-cyan-300">Apparence</p>
                  <h2 className="mt-1 text-sm font-black text-white">Thème de l’application</h2>
                  <p className="mt-1 text-[10px] leading-4 text-zinc-200">Le thème sombre reste actif. Le thème clair sera préparé ensuite avec davantage de blanc.</p>
                </div>
              </div>
              <div className="flex shrink-0 items-center gap-1 rounded-xl border border-white/[0.09] bg-black/20 p-1">
                <button type="button" className="rounded-lg border border-cyan-400/30 bg-cyan-400/[0.08] px-3 py-2 text-[10px] font-black text-cyan-300">Sombre</button>
                <button type="button" className="rounded-lg px-3 py-2 text-[10px] font-black text-zinc-400 opacity-70">Clair · bientôt</button>
              </div>
            </div>
          </section>
