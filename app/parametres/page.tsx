            ...
            >
              <div className="grid gap-2 sm:grid-cols-2">
                {[
                  ...
                  ["JustTCG", "Source complémentaire utilisée lorsque des données compatibles sont disponibles."],
                  ["eBay", "Annonces actives utilisées comme repère complémentaire. Elles ne sont pas présentées comme des ventes conclues."],
                  ["PriceCharting", "Source utilisée dans l'espace PSA pour les prix de cartes gradées disponibles en Anglais, Français et Japonais."],
              ...
              <p className="mt-3 text-[10px] text-zinc-300">
                Les sources restent affichées séparément lorsqu’elles sont disponibles. L’état, la langue, la variante, le marché et la disponibilité réelle peuvent modifier le prix final d’une carte.
              </p>
            </AccordionItem>
