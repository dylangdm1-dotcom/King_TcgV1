  ...
  return (
    <div className="rounded-2xl border border-zinc-900 bg-neutral-900/40 overflow-hidden transition-all shadow-xl">
      ...
      >
        ...
        <span className={`text-[9px] font-black text-zinc-400 transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}>
          ▼
        </span>
      </button>
      ...
      <main className="min-h-screen bg-neutral-950 text-white pb-32 selection:bg-cyan-500/20">
        <div className="mx-auto max-w-3xl space-y-6 px-4 py-6 sm:px-6">
          ...
          <section className="rounded-2xl border border-zinc-900 bg-neutral-900/40 p-5 sm:p-6 shadow-xl">
            <span className="text-[9px] font-black uppercase tracking-wider text-cyan-400 bg-cyan-500/10 border border-cyan-500/20 px-2.5 py-1 rounded-full">Configuration système</span>
            <h1 className="mt-2 text-lg font-black uppercase tracking-tight text-white">Paramètres de King_TCG</h1>
            <p className="mt-0.5 text-[11px] text-zinc-400">Gérez les préférences de votre application et consultez les informations légales.</p>
          </section>
          ...
          <div className="space-y-3">
            ...
            <AccordionItem title="Gestion du Compte & Premium">
              ...
              <p className="text-zinc-400 font-bold uppercase text-[10px] bg-black/40 border border-zinc-800 p-2 rounded-xl">Statut du compte : Session locale active (Invité)</p>
              <div className="pt-1">
                <Link 
            ...
            <AccordionItem title="Nos testeurs professionnels">
              <p>
                Découvrez les membres de la communauté qui participent aux tests
                et contribuent à l'amélioration de King_TCG.
              </p>
              <div className="pt-2">
                <Link
            ...
            <AccordionItem title="Spécifications de la Version">
              <p className="font-bold text-white">Version actuelle : King_TCG v1.0.0</p>
              <p className="text-zinc-400">Modules disponibles :</p>
              ...
              <p className="text-zinc-400 pt-3 font-bold">Prochaines évolutions :</p>
              <ul className="list-disc pl-4 space-y-1 text-zinc-400 font-mono text-[11px]">
                <li>Cloud Sync</li>
              ...
              <p className="text-[10px] text-zinc-500 font-black uppercase tracking-wider pt-3">Dernière mise à jour : Juillet 2026</p>
            </AccordionItem>

            <AccordionItem title="Foire aux Questions (FAQ)">
              <p className="font-bold text-white">Comment sont calculés les prix ?</p>
              ...
              <p className="font-bold text-white pt-2">Les prix sont-ils exacts ?</p>
              ...
              <p className="font-bold text-white pt-2">Comment fonctionne le scanner ?</p>
              ...
              <p className="font-bold text-white pt-2">Les données sont-elles sauvegardées ?</p>
            ...
            <AccordionItem title="Raccordement Support / Contact">
              ...
              <div className="pt-1">
                <a href="mailto:support@kingtcg.com" className="font-mono font-bold text-cyan-400 border-b border-cyan-400/40 hover:border-cyan-400 transition-colors text-xs">
                  support@kingtcg.com
                </a>
              </div>
              <p className="text-zinc-500 text-[11px] italic pt-1">Délai moyen de réponse : sous 24 à 48 heures (jours ouvrés).</p>
            </AccordionItem>
