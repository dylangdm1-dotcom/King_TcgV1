        ...
        <div className="mx-auto max-w-3xl space-y-6 px-4 py-6 sm:px-6">
          ...
          <div className="space-y-2">
            ...
            <Link
             ...
             className="inline-block bg-neutral-950 border border-cyan-500/30 hover:border-cyan-400 text-cyan-400 font-black py-2 px-3 rounded-xl text-[9px] uppercase tracking-wider transition-all"
            >
