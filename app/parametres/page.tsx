...
function StatusPill({ label }: { label: string }) {
  return (
    <div className="flex min-w-0 items-center justify-between gap-2 rounded-[13px] border border-white/[0.06] bg-[#0b1219] px-3 py-2.5">
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-full border border-cyan-400/20 bg-cyan-400/[0.05] px-2 py-1 text-[10px] font-black uppercase tracking-[0.08em] text-cyan-300">
                    Normal / Premium
                  </span>
                </span>
          ...
          <div className="space-y-2.5">
            ...
            >
              <div className="space-y-3">
                ...
                <p className="rounded-xl border border-white/[0.055] bg-white/[0.025] p-3 text-[10px] text-zinc-300">
            ...
            >
              <div className="grid gap-2 sm:grid-cols-2">
                {[
                  ...
                  <div key={title} className="rounded-xl border border-white/[0.055] bg-white/[0.025] p-3">
            ...
            >
              <div className="flex items-start gap-3 rounded-xl border border-white/[0.055] bg-white/[0.025] p-3">
