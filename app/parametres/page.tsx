      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-4xl space-y-6 px-4 py-6 sm:px-6">
          <div className="flex items-center justify-between">
            <Link
              href="/"
              className="inline-flex items-center gap-2 rounded-xl border border-sky-300/25 bg-sky-400/[0.08] px-3.5 py-2 text-[9px] font-black uppercase tracking-wider text-sky-200 transition hover:border-sky-300/45 hover:text-white"
            >
              ← Retour à l’accueil
            </Link>
          </div>
