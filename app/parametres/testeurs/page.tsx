    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-8 px-4 py-6 sm:px-6">
          ...
          <section className="rounded-[20px] border border-cyan-400/20 bg-[#0a1118] p-4 shadow-[0_18px_48px_rgba(0,0,0,.24)] sm:p-5">
              ...
              {activePartners.map((partner, index) => (
                <article
                  ...
                  className={`relative overflow-hidden rounded-[18px] border bg-[#0d141c] p-6 shadow-[0_18px_48px_rgba(0,0,0,.30)] transition duration-200 hover:-translate-y-1 ${
                    index === 1
                      ? "border-emerald-400/55 shadow-[0_0_28px_rgba(52,211,153,.07)] hover:border-emerald-300/75"
                      : "border-cyan-400/50 shadow-[0_0_28px_rgba(34,211,238,.07)] hover:border-cyan-300/70"
                  }`}
                >
                  <div
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    {partner.logo && (
                      <div
                        className={`flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border-2 bg-black/35 p-1 sm:h-36 sm:w-36 ${
                          index === 1
                            ? "border-emerald-400/60 shadow-[0_0_28px_rgba(52,211,153,.10)]"
                            : "border-cyan-400/55 shadow-[0_0_28px_rgba(34,211,238,.10)]"
                        }`}
                      >
                        <img
                          src={partner.logo}
          ...
          <section className="rounded-[20px] border border-cyan-400/25 bg-[#0a1118] p-4 shadow-[0_18px_48px_rgba(0,0,0,.24)] sm:p-5">
            <div className="mb-4 flex items-center gap-3">
              <Users className="h-4 w-4 text-cyan-300" />
              <h2 className="whitespace-nowrap text-[13px] font-black uppercase tracking-[0.08em] text-cyan-300">
                Indicateurs réels des tests effectués
              </h2>
              <span className="h-px flex-1 bg-gradient-to-r from-cyan-400/45 to-transparent" />
            </div>
              ...
              {testerModules.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className={`mt-2 whitespace-nowrap text-[8px] font-black uppercase tracking-[0.025em] sm:text-[10px] ${tone.title}`}>
                      {item.label}
                    </p>
