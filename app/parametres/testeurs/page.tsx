    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen pb-32 text-white">
        <div className="mx-auto max-w-5xl space-y-8 px-4 py-6 sm:px-6">
          ...
          <section className="rounded-[18px] border border-cyan-400/20 bg-[#0b1219] p-4 sm:p-5">
              ...
              {activePartners.map((partner, index) => (
                <article
                  ...
                  className={`relative overflow-hidden rounded-[18px] border bg-[#0d141c] p-6 shadow-[0_18px_48px_rgba(0,0,0,.30)] transition duration-200 hover:-translate-y-1 ${
                    index === 1
                      ? "border-emerald-400/55 shadow-[0_0_26px_rgba(52,211,153,.06)] hover:border-emerald-300/75"
                      : "border-cyan-400/45 shadow-[0_0_26px_rgba(34,211,238,.06)] hover:border-cyan-300/65"
                  }`}
                >
                  <div
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    {partner.logo && (
                      <div className={`flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border-2 bg-black/35 p-1 sm:h-36 sm:w-36 ${
                        index === 1
                          ? "border-emerald-400/60 shadow-[0_0_25px_rgba(52,211,153,.10)]"
                          : "border-cyan-400/55 shadow-[0_0_25px_rgba(34,211,238,.10)]"
                      }`}>
                        <img
                          src={partner.logo}
          ...
          <section className="rounded-[18px] border border-cyan-400/25 bg-[#0b1219] p-4 sm:p-5">
            <div className="mb-4 flex items-center gap-3">
