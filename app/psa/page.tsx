            ...
            {[
              ...
              >
                <span className="flex items-center justify-center gap-1.5">
                  {tab.id === "estimation" ? (
                    <img src="/brands/psa.png" alt="" aria-hidden="true" className="h-4 w-8 rounded-sm object-contain" />
                  ) : null}
                  {tab.label}
                </span>
              </button>
              ...
              <div className="kt-premium-panel rounded-[20px] p-4 sm:p-5">
                <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="mt-2 inline-flex rounded-full border border-amber-300/15 bg-amber-400/[0.06] px-3 py-1.5 text-[9px] font-black uppercase tracking-wider text-amber-200">Estimation non officielle</span>
                    </div>
                  </div>
                </div>
