            ...
            <section className="space-y-6">
              <div className="kt-premium-panel rounded-[20px] p-4 sm:p-5">
                <div className="grid gap-3 sm:grid-cols-[1fr_auto] sm:items-start">
                  ...
                  <span className="justify-self-start rounded-full border border-amber-300/15 bg-amber-400/[0.06] px-3 py-1.5 text-[9px] font-black uppercase tracking-wider text-amber-200 sm:justify-self-end sm:self-center">Estimation non officielle</span>
                </div>
              </div>
