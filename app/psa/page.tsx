    ...
    <>
      ...
      <main className="kt-premium-shell min-h-screen text-white pb-32">
        <div className="mx-auto max-w-6xl px-4 py-6 space-y-6">
          ...
          {/* HEADER */}
          <section className="kt-hero-surface relative overflow-hidden rounded-[22px] border p-5 sm:p-6">
          ...
          <section className="kt-section-surface overflow-hidden rounded-[18px] border p-3 sm:p-4">
            <div className="grid gap-2.5 md:grid-cols-3">
              <div className="kt-data-row rounded-[15px] border p-3">
