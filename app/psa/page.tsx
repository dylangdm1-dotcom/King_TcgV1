        ...
        <div className="mx-auto max-w-6xl px-4 py-6 space-y-6">
              ...
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                    <h1 className="text-[22px] font-black tracking-tight text-white sm:text-[26px]">Espace PSA</h1>
          ...
          <section className="overflow-hidden rounded-[18px] border border-white/[0.09] bg-[#0a1118] p-3 shadow-[0_14px_34px_rgba(0,0,0,.18)] sm:p-4">
            <div className="grid gap-2.5 md:grid-cols-3">
              ...
              <div className="rounded-[15px] border border-cyan-400/13 bg-cyan-400/[0.03] p-3">
                <div className="flex items-center gap-2">
                  <div className="flex h-7 w-12 shrink-0 items-center justify-center rounded-lg border border-white/[0.06] bg-white px-1 py-0.5">
                    <img
              ...
              <div className="rounded-[15px] border border-cyan-400/13 bg-cyan-400/[0.03] p-3">
                <div className="flex items-center gap-2">
                  <div className="flex h-7 w-11 shrink-0 items-center justify-center rounded-lg border border-white/[0.06] bg-white px-1 py-0.5">
                    <img
                      src="/brands/psa.png"
                      alt="PSA"
                      className="h-full w-full object-contain"
                        ...
                        <div className="shrink-0">
                          {card.imageUrl ? (
                            <img
                              src={card.imageUrl}
                              alt={card.cardName}
                              className="h-28 w-20 rounded-[16px] border border-white/[0.06] bg-white/[0.045] object-contain shadow-[0_14px_34px_rgba(0,0,0,0.35)] sm:h-32 sm:w-24"
                              onError={(event) => {
                                event.currentTarget.style.display = "none";
                              }}
                            />
                          ) : (
                            <div className="flex h-28 w-20 items-center justify-center rounded-[16px] border border-white/[0.06] bg-white/[0.045] sm:h-32 sm:w-24">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-wrap items-start justify-between gap-2">
                            ...
                            <button
                              ...
                              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/[0.06] bg-white/[0.04] text-zinc-200 transition hover:border-red-400/30 hover:bg-red-500/10 hover:text-red-400 active:scale-95"
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4 rounded-[18px] border border-cyan-400/13 bg-[#0a1118] p-4 shadow-[0_16px_38px_rgba(0,0,0,.20)] sm:p-5">
                ...
                >
                  <input
                    ...
                    className="flex-1 rounded-2xl border border-white/[0.06] bg-white/[0.045] px-4 py-3 text-xs text-white outline-none transition focus:border-cyan-400/50"
                  />
              ...
              <div className="space-y-5">
                {priceChartingResults.map((card) => (
                  <div
                    key={card.id}
                    className="psa-result-card rounded-[18px] border border-white/[0.09] bg-[linear-gradient(145deg,rgba(27,32,41,.96),rgba(17,21,28,.96))] p-4 space-y-4"
                  >
          ...
          <div className="kt-premium-panel w-full max-w-md rounded-[18px] p-6 space-y-5">
            ...
            >
              <input
                ...
                className="w-full rounded-2xl border border-white/[0.06] bg-white/[0.045] px-4 py-3 text-xs text-white outline-none transition focus:border-cyan-400/50"
              />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <input
                  ...
                  className="rounded-xl border border-white/[0.06] bg-[#11151b] px-3 py-3 text-xs text-white"
                />
              </div>
