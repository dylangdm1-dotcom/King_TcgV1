                      ...
                      <div className="shrink-0">
                        ...
                        >
                          <div className="text-center px-2">
                            ...
                            <span className="block mt-2 text-[10px] text-zinc-500 uppercase font-black">
                              Image indisponible
                            </span>
                          </div>
                        </div>
          ...
          <div className="kt-premium-panel w-full max-w-md rounded-[18px] p-6 space-y-5">
            ...
            >
              ...
              <label className="block">
                <span className="mb-1.5 block text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-500">Prix d'achat</span>
                <input
                  type="number"
                  min="0"
                  step="0.01"
