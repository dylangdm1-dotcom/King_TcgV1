                        ...
                        <div className="shrink-0">
                          {card.imageUrl ? (
                            <img
                              src={card.imageUrl}
                              alt={card.cardName}
                              className="h-28 w-20 rounded-[16px] border border-white/[0.08] bg-white/[0.045] object-contain shadow-[0_14px_34px_rgba(0,0,0,0.35)] sm:h-32 sm:w-24"
                              onError={(event) => {
                                event.currentTarget.style.display = "none";
                              }}
                            />
                          ) : (
                            <div className="flex h-28 w-20 items-center justify-center rounded-[16px] border border-white/[0.08] bg-white/[0.045] sm:h-32 sm:w-24">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-wrap items-start justify-between gap-2">
                            ...
                            <button
                              ...
                              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.04] text-zinc-200 transition hover:border-red-400/30 hover:bg-red-500/10 hover:text-red-400 active:scale-95"
              ...
              <div className="space-y-4 rounded-[18px] border border-cyan-400/13 bg-[#0a1118] p-4 shadow-[0_16px_38px_rgba(0,0,0,.20)] sm:p-5">
                ...
                >
                  <input
                    ...
                    className="flex-1 rounded-2xl border border-white/[0.08] bg-white/[0.045] px-4 py-3 text-xs text-white outline-none transition focus:border-cyan-400/50"
                  />
          ...
          <div className="kt-premium-panel w-full max-w-md rounded-[18px] p-6 space-y-5">
            ...
            >
              <input
                ...
                className="w-full rounded-2xl border border-white/[0.08] bg-white/[0.045] px-4 py-3 text-xs text-white outline-none transition focus:border-cyan-400/50"
              />
