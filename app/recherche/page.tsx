...
function hasPublishedCards(set: SetItem): boolean {
  return set.availability === "available" || Number(set.total || set.printedTotal || 0) > 0;
}
                            ...
                            {generationSets.map((set) => (
                              ...
                              >
                                ...
                                <span className="shrink-0 pl-1 text-right">
                                  ...
                                  <span className={`block text-[9px] font-bold uppercase tracking-wide ${set.availability === "announced" ? "text-amber-300" : "text-zinc-600"}`}>{set.availability === "announced" ? "à venir" : "cartes"}</span>
