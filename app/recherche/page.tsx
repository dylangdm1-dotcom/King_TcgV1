        ...
        <div className="kt-page-wrap space-y-5">
          <section className="kt-page-header kt-rise-in kt-hero-surface relative space-y-5 overflow-hidden border">
            ...
            <div className="flex flex-col justify-between gap-4 border-b border-white/[0.06] pb-5 md:flex-row md:items-center">
              ...
              <div className="kt-language-panel flex w-full self-start items-center gap-1.5 rounded-2xl border border-sky-300/35 bg-sky-300/[0.09] p-1.5 shadow-[0_0_26px_rgba(125,211,252,.09)] md:w-auto md:self-auto">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex h-8 min-w-0 flex-1 items-center justify-center rounded-lg border text-base transition md:w-9 md:flex-none ${selectedLanguage === lang.code ? "border-sky-200/60 bg-sky-300/[0.19] text-white shadow-[0_0_16px_rgba(125,211,252,.14)]" : "border-sky-200/15 text-zinc-200 hover:border-sky-200/35 hover:bg-sky-300/[0.11] hover:text-white"}`}
                  >
                    {lang.label}
                  </button>
                ))}
