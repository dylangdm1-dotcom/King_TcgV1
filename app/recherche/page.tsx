      ...
      <main className="kt-app-shell selection:bg-cyan-500/20">
        <div className="kt-page space-y-6">
          ...
          <section className="kt-premium-card kt-rise-in space-y-5 p-4 sm:p-6">
            <div className="flex flex-col justify-between gap-4 border-b border-white/[0.06] pb-5 md:flex-row md:items-center">
              <div>
                ...
                Recherchez une carte, puis laissez les prix visibles se synchroniser. Cardmarket et TCGPlayer sont rapprochés à partir de l’identifiant, du set et du numéro de carte.
                </p>
              </div>

              {/* Sélecteur de Région/Langue */}
              <div className="flex self-start items-center gap-1 rounded-2xl border border-white/[0.07] bg-[#111821]/85 p-1.5 md:self-auto">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-[10px] font-black tracking-wider transition-all ${
                      selectedLanguage === lang.code
                        ? "bg-white text-[#0a1017] shadow-md shadow-black/20"
            ...
            <div className="inline-flex w-full gap-2 rounded-2xl border border-white/[0.06] bg-[#111821]/70 p-1.5 sm:w-auto">
              <button
          ...
          <section className="kt-premium-card-soft flex items-center justify-between gap-4 p-3">
            <div className="rounded-xl border border-white/[0.09] bg-[#171e28]/80 px-3.5 py-2 text-[10px] font-black uppercase tracking-wider text-zinc-300 flex items-center gap-2">
            ...
            <div className="flex gap-1 rounded-xl border border-white/[0.09] bg-[#171e28]/80 p-1">
              <button
          ...
          {loading && (
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              {Array.from({ length: 12 }).map((_, i) => (
                <div
                  key={i}
                  className="aspect-[0.72] animate-pulse rounded-2xl bg-[#171e28]/80 border border-white/[0.08] p-3 flex flex-col justify-between"
                >
          ...
          {!loading && query.length >= 2 && filteredCards.length === 0 && (
            <div className="rounded-2xl border border-white/[0.09] bg-[#151c25] p-10 text-center shadow-inner">
          ...
          {syncingPriceIds.size > 0 && (
            <div className="flex items-center gap-2 rounded-xl border border-cyan-500/15 bg-cyan-500/[0.05] px-3.5 py-2.5 text-[10px] font-bold text-cyan-300">
              ...
              Synchronisation des prix : {syncingPriceIds.size} carte(s) visible(s) en cours…
            </div>
          )}
