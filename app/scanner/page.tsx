      ...
      <main className="min-h-screen bg-neutral-950 text-white pb-32 selection:bg-cyan-500/20">
        <div className="mx-auto max-w-xl space-y-4 px-4 py-5">
          ...
          <section className="rounded-2xl border border-zinc-900 bg-neutral-900/40 p-4 text-center shadow-xl flex flex-col items-center gap-3">
            ...
            <div className="w-full max-w-md rounded-xl border border-cyan-500/15 bg-cyan-500/[0.04] p-3 text-left">
              <p className="text-[10px] font-black uppercase tracking-widest text-cyan-400">
                Comment utiliser le scanner
              </p>
              <div className="mt-2 space-y-1.5 text-[10px] leading-relaxed text-zinc-400">
                <p>
                  <span className="font-bold text-white">Mono</span> — scannez une carte à la fois pour obtenir une identification détaillée.
                </p>
                <p>
                  <span className="font-bold text-white">Batch</span> — placez jusqu’à 4 cartes dans le cadre pour les analyser ensemble.
                </p>
              </div>
              <div className="mt-3 border-t border-white/[0.06] pt-2 text-[9px] leading-relaxed text-zinc-500">
                <p>🇫🇷 Les cartes françaises sont actuellement identifiées et recherchées dans la base.</p>
                <p className="mt-1">🇯🇵 🇨🇳 Les cartes japonaises et chinoises sont détectées, mais leur recherche reste en cours d’amélioration.</p>
              </div>
            </div>
