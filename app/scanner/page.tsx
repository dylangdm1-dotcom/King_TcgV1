      ...
      <main className="kt-premium-shell min-h-screen text-white pb-32 selection:bg-cyan-500/20">
        <div className="mx-auto max-w-xl space-y-4 px-4 py-5">
                ...
                {premiumModesOpen && (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="mt-1 text-[10px] leading-4 text-zinc-400">Jusqu’à 4 cartes scannées à la suite.</p>
                    </button>
                    ...
                    >
                      ...
                      <p className="mt-1 text-[10px] leading-4 text-zinc-400">Jusqu’à 4 cartes sur une seule photo.</p>
                    </button>
                  </motion.div>
                )}
              </AnimatePresence>
          ...
          <div className="kt-premium-panel rounded-[18px] px-4 py-3 flex items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-500">Quota scanner</p>
              <p className="mt-0.5 text-xs font-black text-white">{quotaUsed} / {SCANNER_MONTHLY_LIMIT} sessions</p>
              <p className="mt-0.5 text-[10px] text-zinc-500">Renouvellement le {quotaEnd ? new Date(quotaEnd).toLocaleDateString("fr-FR") : "5 du mois"}</p>
            </div>
