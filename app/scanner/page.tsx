              ...
              <AnimatePresence initial={false}>
                {premiumModesOpen && (
                  <motion.div
                    ...
                    className="grid grid-cols-2 gap-2 rounded-2xl border border-amber-300/35 bg-amber-400/[0.07] p-2 shadow-[0_0_28px_rgba(245,196,81,.08)]"
                  >
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="rounded-xl border border-sky-300/38 bg-sky-400/[0.08] px-3 py-2.5 text-left transition-all hover:border-sky-200/60 hover:bg-sky-400/[0.12]"
                    >
                    ...
                    <button
                      ...
                      className="rounded-xl border border-violet-300/38 bg-violet-400/[0.08] px-3 py-2.5 text-left transition-all hover:border-violet-200/60 hover:bg-violet-400/[0.12]"
                    >
