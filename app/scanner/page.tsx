                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-1.5">
                    ...
                    <p className={`text-[10px] font-black uppercase tracking-[0.16em] ${
                      ...
                      {scanMode === "single" ? "Mono · Normal" : "Premium"}
                    </p>
                  </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                        <Crown className="h-3.5 w-3.5 text-amber-300" />
                        <p className="text-[10px] font-black uppercase tracking-[0.16em] text-amber-300">Premium</p>
                      </div>
                      <h2 className={`mt-1 truncate text-sm font-black ${
                        batchCaptureMode === "grouped" ? "text-violet-200" : "text-sky-200"
                      }`}>
                        {batchCaptureMode === "grouped" ? "Quad" : "Batch · Scan multiples"}
                      </h2>
                      <p className="mt-1 text-[10px] leading-4 text-zinc-100">
                        {batchCaptureMode === "grouped"
                          ? "Capturez jusqu’à 4 cartes sur une seule photo."
