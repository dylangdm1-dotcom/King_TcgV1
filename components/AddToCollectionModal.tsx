...
export default function AddToCollectionModal({
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/85 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-xl border border-white/[0.08] bg-neutral-950 p-5 shadow-2xl relative animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="mt-4 flex gap-3 rounded-lg border border-white/[0.08] bg-neutral-900/20 p-3">
        ...
        <div className="mt-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="0.00"
              className="h-10 w-full rounded-xl border border-white/[0.08] bg-neutral-950 px-3 text-xs font-bold text-white outline-none transition focus:border-cyan-500/30 tabular-nums"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="h-10 w-full rounded-xl border border-white/[0.08] bg-neutral-950 px-3 text-xs font-bold text-zinc-300 outline-none transition focus:border-cyan-500/30 cursor-pointer"
              >
          ...
          <div className="rounded-xl border border-white/[0.08] bg-[#111821]/85 p-3 text-xs font-medium text-zinc-400 space-y-1.5 border-dashed">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="h-9 px-4 rounded-xl border border-white/[0.08] text-xs font-bold text-zinc-400 transition hover:bg-neutral-900 hover:text-white active:scale-95 cursor-pointer"
            >
              Annuler
            </button>
            <button
