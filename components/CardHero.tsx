    ...
    <div className="relative grid items-center gap-7 lg:grid-cols-[minmax(280px,390px)_1fr] lg:gap-12">
      <div className="relative mx-auto w-full max-w-[390px]">
        ...
        <div className="kt-card-stage group relative mx-auto w-fit">
          ...
          <div className="relative rounded-[22px] border border-white/[0.08] bg-[#090c10]/95 p-3 shadow-[0_30px_80px_rgba(0,0,0,.58)] transition duration-300 group-hover:-translate-y-1 group-hover:border-cyan-400/20">
            <img
              src={image}
              alt={name}
