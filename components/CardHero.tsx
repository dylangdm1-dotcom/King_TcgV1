  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(245px,330px)_1fr] lg:items-start lg:gap-7">
      <div className="relative mx-auto w-full max-w-[330px]">
        ...
        <div className="kt-card-frame relative overflow-hidden rounded-[22px] bg-[#0a1118] p-3 shadow-[0_28px_70px_rgba(0,0,0,.50),0_0_30px_rgba(34,211,238,.04)]">
      ...
      <div className="min-w-0 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-1 rounded-[16px] bg-[#0c141c] p-2.5">
          ...
          <div className="kt-metric-cell rounded-[12px] border px-2.5 py-2.5">
