  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        {/* Quantité */}
        <div className="glass-card bg-[#111821]/85 rounded-xl px-2.5 py-2 flex flex-col justify-between min-h-[62px]">
          <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-400">Quantité</span>
        ...
        {/* Investissement */}
        <div className="glass-card bg-[#111821]/85 rounded-xl px-2.5 py-2 flex flex-col justify-between min-h-[62px]">
          <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-400">Investi</span>
          <span className="text-sm font-black text-white mt-3 tabular-nums">{totalInvested.toFixed(2)} €</span>
        </div>

        {/* Valeur Actuelle */}
        <div className="glass-card bg-[#111821]/85 rounded-xl px-2.5 py-2 flex flex-col justify-between min-h-[62px]">
          <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-400">Valeur totale</span>
          <span className="text-sm font-black text-white mt-3 tabular-nums">{totalValue.toFixed(2)} €</span>
        </div>

        {/* ROI / Performance */}
        <div className="glass-card bg-[#111821]/85 rounded-xl px-2.5 py-2 flex flex-col justify-between min-h-[62px]">
          <span className="text-[9px] font-bold uppercase tracking-wider text-zinc-400">Performance</span>
