  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
        {/* Quantité */}
        <div className="glass-card bg-[#111821]/85 rounded-xl p-4 flex flex-col justify-between min-h-[95px]">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 pt-2 border-t border-white/[0.08]">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-white/[0.08] bg-[#111821]/85 px-3 py-2.5 text-xs text-white placeholder-zinc-700 transition focus:border-cyan-500/50 focus:outline-none focus:bg-neutral-950 tabular-nums"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full rounded-xl border border-white/[0.08] bg-[#111821]/85 px-3 py-2.5 text-xs text-white transition focus:border-cyan-500/50 focus:outline-none focus:bg-neutral-950 appearance-none cursor-pointer"
          >
