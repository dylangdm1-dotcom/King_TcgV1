...
import { RefreshCw, Scale, ShoppingCart } from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-[1.35fr_.65fr]">
        <div className="relative overflow-hidden rounded-[20px] border border-emerald-300/15 bg-[linear-gradient(135deg,rgba(16,185,129,.10),rgba(21,29,39,.96)_48%)] p-5">
          <div className="pointer-events-none absolute -right-8 -top-10 h-28 w-28 rounded-full bg-emerald-300/10 blur-3xl" />
          <div className="relative flex items-start justify-between gap-3">
            <div>
              <p className="text-[9px] font-black uppercase tracking-[0.16em] text-emerald-200/70">Référence consolidée</p>
              <p className="mt-1 text-[11px] font-medium text-zinc-400">Moyenne King_TCG calculée uniquement à partir des sources trouvées.</p>
            </div>
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-emerald-200/15 bg-emerald-200/[0.08] text-emerald-200">
