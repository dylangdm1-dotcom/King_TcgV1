        ...
        <div className="relative mx-auto flex min-h-[64px] max-w-7xl items-center justify-between px-3 sm:px-6">
          ...
          <div className="flex items-center justify-end gap-1.5 pl-2 sm:gap-2 sm:pl-5">
            <Link
              ...
              className={`flex h-10 min-w-[50px] items-center justify-center rounded-xl border px-1 text-[10px] font-black uppercase tracking-wider transition ${
            ...
            >
              <img src="/brands/psa.png" alt="PSA" className="h-8 w-12 rounded-md bg-white p-[2px] object-contain" />
            </Link>
            <NotificationBell />
