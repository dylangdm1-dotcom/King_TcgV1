  ...
  return (
    <>
      <nav className="sticky top-0 z-50 border-b border-cyan-400/[0.08] bg-[#090d13]/94 shadow-[0_14px_38px_rgba(0,0,0,.34)] backdrop-blur-2xl">
        <div className="relative mx-auto flex min-h-[64px] max-w-[1180px] items-center justify-between px-3 sm:px-5">
          ...
          <div className="flex items-center justify-end gap-1.5 pl-2 sm:gap-2 sm:pl-5">
            <Link
              href="/psa"
              title="Accès rapide PSA"
              aria-label="Accès rapide PSA"
              className={`flex h-10 min-w-[50px] items-center justify-center rounded-xl border px-1 text-[10px] font-bold uppercase tracking-wide transition ${
            ...
            >
              <img src="/brands/psa.png" alt="PSA" className="h-8 w-12 rounded-md object-contain" />
            </Link>
            <NotificationBell />
