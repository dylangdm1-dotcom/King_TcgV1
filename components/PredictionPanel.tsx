    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-3 lg:grid-cols-[1.35fr_.65fr]">
        <div className="relative overflow-hidden rounded-3xl border border-cyan-400/14 bg-cyan-400/[0.035] p-6 text-center">
          ...
          <p className="relative mt-2 text-[10px] font-medium text-zinc-600">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-1">
          <div className="kt-market-metric text-center lg:text-left">
            <div className="flex items-center justify-center gap-2 lg:justify-start">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-zinc-600">ROI potentiel</span>
            </div>
          ...
          <div className="kt-market-metric text-center lg:text-left">
            <div className="flex items-center justify-center gap-2 lg:justify-start">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-zinc-600">Confiance</span>
            </div>
