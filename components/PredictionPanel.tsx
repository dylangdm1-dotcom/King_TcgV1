  ...
  return (
    <div className="space-y-2.5">
      <div>
        ...
        <p className="mt-1 text-[10px] font-medium leading-4 text-zinc-400">
      ...
      <div className="grid gap-3 lg:grid-cols-[1.35fr_.65fr]">
        ...
        <div className="rounded-[17px] border border-white/[0.09] bg-[#1a222c] p-3.5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.15em] text-zinc-500">Confiance du modèle</span>
          </div>
          <p className={`mt-2 text-2xl font-black tabular-nums ${confidenceTone}`}>{confidence.toFixed(0)} %</p>
          <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-black/30 ring-1 ring-white/[0.04]">
