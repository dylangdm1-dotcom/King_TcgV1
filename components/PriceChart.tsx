...
export default function PriceChart({ history }: Props) {
  ...
  if (!history || history.length === 0) {
    return (
      <div className="kt-premium-card rounded-[18px] p-8 text-center text-xs font-bold text-zinc-200">
    ...
    <div className="kt-premium-card space-y-4 p-4 sm:p-5">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="max-w-lg text-[10px] font-medium leading-4 text-zinc-200">
            Suivi de la cote King_TCG. Quand l’historique local est encore trop court, la courbe est reconstituée à partir de la cote et des tendances marché disponibles, sans représenter de fausses ventes.
          </p>
      ...
      {/* Graphique */}
      <div className="rounded-[18px] border border-white/[0.09] bg-[linear-gradient(180deg,#1a222c,#131923)] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,.035),0_18px_45px_rgba(0,0,0,.22)]">
