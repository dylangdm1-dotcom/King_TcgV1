...
export default function PriceChart({ history }: Props) {
  ...
  if (!history || history.length === 0) {
    return (
      <div className="rounded-xl border border-white/[0.08] bg-[#111821]/85 p-8 text-center text-xs font-bold text-zinc-500">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        {/* Choix période */}
        <div className="flex rounded-lg border border-white/[0.08] bg-neutral-950/60 p-0.5">
          {periods.map((item) => (
            <button
              key={item.value}
