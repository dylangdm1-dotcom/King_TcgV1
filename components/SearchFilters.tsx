...
export default function SearchFiltersComponent({
  ...
  return (
    <div className="my-4 grid grid-cols-1 gap-2.5 sm:grid-cols-2 lg:grid-cols-5">
      
      {/* Catégories */}
      <select
        className="kt-control h-10 cursor-pointer border px-3 text-xs font-bold outline-none transition-all duration-150"
      ...
      <select
        className="kt-control h-10 cursor-pointer border px-3 text-xs font-bold text-cyan-300 outline-none transition-all duration-150"
