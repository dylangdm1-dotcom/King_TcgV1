      ...
      <article className="group relative overflow-hidden rounded-xl border border-zinc-900 bg-neutral-950/40 p-3 transition-all duration-200 hover:border-cyan-500/30 hover:bg-neutral-950/60">
        ...
        <div className="mt-3 space-y-2.5">
          ...
          <div className="flex gap-1.5">
            ...
            <span className="rounded bg-cyan-500/5 border border-cyan-500/10 px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wider text-cyan-500">
              {market.condition}
            </span>
          </div>
          ...
          <div className="flex items-center justify-between border-t border-zinc-900 pt-2.5">
              ...
              {market.lowestPrice > 0 ? (
                <>
                  ...
                  <p className="text-[9px] text-zinc-600">
                    {market.sourceCount} source
                    {market.sourceCount > 1 ? "s" : ""}
                  </p>
                </>
              ) : (
            ...
            <div className="flex h-6 w-6 items-center justify-center rounded-md border border-zinc-900 bg-neutral-950 text-zinc-500 transition-all duration-200 group-hover:border-cyan-500/20 group-hover:bg-cyan-500/10 group-hover:text-cyan-400">
