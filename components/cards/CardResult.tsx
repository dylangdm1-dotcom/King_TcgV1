...
export default function CardResult({ card }: Props) {
  ...
  return (
    <article className="kt-search-card kt-card-frame group flex h-full flex-col overflow-hidden bg-[#18212b] shadow-[0_18px_44px_rgba(0,0,0,.22)]">
      <Link href={`/card/${card.id}`} className="block">
        <div className="kt-card-frame relative aspect-[0.72] overflow-hidden rounded-[15px] bg-[#17202a]">
