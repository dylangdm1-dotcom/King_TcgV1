...
export default function CollectionCardTile({
  ...
  return (
    <Link
      href={`/card/${card.id}`}
      className="group relative min-w-0 overflow-hidden rounded-[18px] border border-cyan-400/16 bg-[#0a1118] p-2 shadow-[0_16px_38px_rgba(0,0,0,.22)] transition duration-200 hover:-translate-y-1 hover:border-cyan-300/35 hover:shadow-[0_20px_46px_rgba(0,0,0,.28),0_0_22px_rgba(34,211,238,.045)] sm:p-2.5"
    >
      <div className="pointer-events-none absolute inset-x-8 top-2 h-16 rounded-full bg-cyan-400/[0.035] blur-2xl" />

      <div className="relative aspect-[0.72] overflow-hidden rounded-[14px] border border-white/[0.09] bg-[#0c151e]">
        <img
