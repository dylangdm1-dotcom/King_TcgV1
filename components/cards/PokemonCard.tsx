...
export default function PokemonCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-white/[0.08] bg-[#111821]/85 p-3 transition-all duration-200 hover:border-cyan-500/30 hover:bg-neutral-950/60">
      
      {/* Zone Image Technique */}
      <div className="relative aspect-[0.72] w-full overflow-hidden rounded-lg bg-neutral-950 border border-white/[0.08]/50 flex items-center justify-center p-2">
        <img
          src={image}
          alt={name}
          loading="lazy"
      ...
      <div className="mt-3 space-y-2.5">
        ...
        <div className="flex items-center justify-between border-t border-white/[0.08] pt-2.5">
          ...
          <button 
            type="button"
            className="flex h-6 w-6 items-center justify-center rounded-md border border-white/[0.08] bg-neutral-950 text-zinc-500 transition-all duration-200 hover:border-rose-500/30 hover:bg-rose-500/10 hover:text-rose-400 active:scale-95 cursor-pointer"
          >
