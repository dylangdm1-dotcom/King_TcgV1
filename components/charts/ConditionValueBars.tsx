...
export default function ConditionValueBars({ data }: { data: ConditionValueDatum[] }) {
  ...
  if (!visible.length) {
    return <div className="kt-empty-state flex min-h-[96px] items-center justify-center rounded-2xl px-5 text-center text-[10px] font-semibold">Ajoutez l’état de vos cartes pour afficher cette répartition.</div>;
  }
