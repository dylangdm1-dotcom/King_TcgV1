...
export default function PortfolioChart() {
  ...
  return (
    <section className="rounded-xl border border-white/[0.08] bg-[#111821]/85 p-5 sm:p-6">
      {/* En-tête Métriques */}
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs font-bold flex items-center gap-1">
            ...
            <span className="text-[10px] font-medium text-zinc-500 uppercase tracking-wide">(Glissement 7j)</span>
          </p>
        </div>
      ...
      <div className="w-full overflow-hidden rounded-lg bg-neutral-950/60 p-2 border border-white/[0.08]/50">
