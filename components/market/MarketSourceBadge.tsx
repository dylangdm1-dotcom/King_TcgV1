...
export type MarketSource = "cardmarket" | "tcgplayer" | "justtcg" | "ebay" | "pricecharting";
...
const sourceMap: Record<MarketSource, SourceItem> = {
  ...
  justtcg: { label: "JustTCG", fallback: "J", className: "border-violet-300/25 bg-violet-400/[0.10] text-violet-100" },
  ebay: {
    label: "eBay",
