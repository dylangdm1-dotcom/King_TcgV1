                ...
                {notifications.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      key={item.id}
                      onClick={() => setOpen(false)}
                      className="group flex items-start gap-3 rounded-2xl border border-white/[0.12] bg-[#1b222c] p-3.5 shadow-[0_8px_22px_rgba(0,0,0,.18)] transition hover:border-cyan-100/25 hover:bg-[#202934]"
                    >
