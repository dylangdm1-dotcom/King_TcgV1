  ...
  return (
    <div className="absolute inset-0 z-10 pointer-events-none select-none overflow-hidden">
      ...
      >
        ...
        {scanning && !hasResult && (
          <div className="absolute left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-cyan-400 to-transparent shadow-[0_0_22px_rgba(34,211,238,.85)] animate-scan" />
        )}
      </div>
      ...
      <div className="absolute bottom-[6%] inset-x-0 flex justify-center px-4">
        <div
          className={`
            flex items-center gap-2.5 rounded-2xl border px-4 py-3 text-[10px] sm:text-[11px] font-black uppercase tracking-widest shadow-2xl backdrop-blur-md transition-all duration-300 text-center
            ${
              hasResult
                ? "border-emerald-500/60 bg-emerald-950/90 text-emerald-400 shadow-emerald-900/30"
                : scanning
                ? "border-cyan-500/60 bg-[#090b0f]/92 text-cyan-400 shadow-cyan-900/30"
