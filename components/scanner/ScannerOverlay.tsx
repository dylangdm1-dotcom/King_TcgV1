        ...
        <>
          ...
          {QUAD_FRAMES.map((frame, index) => (
            ...
            >
              ...
              <span className="absolute bottom-1.5 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-black/65 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.11em] text-zinc-200 backdrop-blur-md">
                Carte {index + 1}
              </span>
              {scanning && !hasResult && (
