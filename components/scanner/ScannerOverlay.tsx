  ...
  return (
    <div className="absolute inset-0 z-10 pointer-events-none select-none overflow-hidden">
      ...
      >
        <div
          className={`
            absolute -left-1 -top-1 h-7 w-7 rounded-tl-xl border-l-4 border-t-4
        ...
        <div
          className={`
            absolute -right-1 -top-1 h-7 w-7 rounded-tr-xl border-r-4 border-t-4
            transition-colors duration-300
            ${
              hasResult
                ? "border-emerald-400"
        ...
        <div
          className={`
            absolute -bottom-1 -left-1 h-7 w-7 rounded-bl-xl border-b-4 border-l-4
            transition-colors duration-300
            ${
              hasResult
                ? "border-emerald-400"
        ...
        <div
          className={`
            absolute -bottom-1 -right-1 h-7 w-7 rounded-br-xl border-b-4 border-r-4
            transition-colors duration-300
            ${
              hasResult
                ? "border-emerald-400"
        ...
        <div
          className={`
            absolute left-[4%] top-[3.5%] flex h-[11%] w-[92%]
            items-center justify-between rounded-xl border px-2.5
        ...
        <div
          className={`
            absolute bottom-[8.5%] left-[5%] flex h-[8.5%] w-[42%]
            items-center justify-between rounded-xl border border-dashed px-2
            transition-all shadow-md
            ${
              hasResult
                ? "border-emerald-500/40 bg-emerald-500/20"
      ...
      <div className="absolute bottom-[6%] inset-x-0 flex justify-center px-4">
        <div
          className={`
            ...
            shadow-2xl backdrop-blur-md transition-all duration-300 text-center
            ${
              hasResult
