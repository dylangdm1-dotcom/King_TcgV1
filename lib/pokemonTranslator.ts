 ...
 */
 ...
 import { normalizeCompact } from "./pokemon/normalize";
 import { resolveOcrAlias } from "./pokemon/ocrAliases";
 ...
 function normalizeName(name: string): string {
   if (!name) return "";
   return normalizeCompact(fixOCRCharacterConfusion(name).replace(/[♀♂]/g, ""));
 }
