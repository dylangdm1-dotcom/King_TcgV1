...
/**
 * 🔄 Traduit un Pokémon français vers anglais
 */
 export function translatePokemonToEnglish(name: string): string | null {
  ...
  return pokemonNames[clean] ?? null;
}

/**
 * 🔄 Fonction utilisée par le moteur de recherche
 */
 ...
 * Exemple : Dracaufeu ex -> Dracaufeu
 */
...
/**
 * 🧠 Correction des erreurs OCR avant recherche API
 */
...
/**
 * 🔎 Correction simple des erreurs OCR
 */
