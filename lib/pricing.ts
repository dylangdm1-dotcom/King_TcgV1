 ...
 */
export function getConditionMultiplier(_condition: string): number {
  // Aucun coefficient synthétique : les prix par état seront fournis
  // uniquement lorsqu'une source réelle les expose.
  return 1;
}
