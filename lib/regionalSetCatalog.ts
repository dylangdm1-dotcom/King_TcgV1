...
export const CHINESE_AUDITED_AVAILABLE_SET_COUNTS: Record<string, number> = {
  "151C": 192,
  "30THP": 9,
  "CBB1C": 115,
  "CBB2C": 140,
...
export function auditedChineseAvailableCount(value: unknown): number {
  const code = String(value || "").trim().toUpperCase();
  return CHINESE_AUDITED_AVAILABLE_SET_COUNTS[code] || 0;
}
...
export const CHINESE_SET_CATALOG: RegionalSetEntry[] = [
  ...
  { code: "CSVH3C", name: "Scarlet & Violet High Class Chinese 3", era: "Scarlet & Violet" },
  ...
  { code: "CS6.1C", name: "Wild Force", era: "Sword & Shield" },
  ...
  { code: "CS5.1C", name: "Ancient Roar", era: "Sword & Shield" },
  { code: "CS4.5C", name: "Final Flame Dance", era: "Sword & Shield" },
  { code: "CS4.1C", name: "Paradise Dragona", era: "Sword & Shield" },
  ...
  { code: "CS3.5C", name: "Scorching Skies", era: "Sword & Shield" },
  { code: "CS2BC", name: "Vivid Portrayals Indigo", era: "Sword & Shield" },
  { code: "CS2AC", name: "Vivid Portrayals Obsidian", era: "Sword & Shield" },
  { code: "CS2.5C", name: "Brilliant Counterattack", era: "Sword & Shield" },
  { code: "CS1BC", name: "Dynamax Clash Flame", era: "Sword & Shield" },
  { code: "CS1AC", name: "Dynamax Clash Thunder", era: "Sword & Shield" },
  { code: "CS1.5C", name: "Dynamax Tactics", era: "Sword & Shield" },
  { code: "CSDC", name: "Dynamax Collection", era: "Sword & Shield" },
  { code: "CSM2.5C", name: "Sun & Moon 2 Chinese: 2.5", era: "Sun & Moon" },
  ...
  { code: "CSM1.5C", name: "Sun & Moon Chinese: 1.5", era: "Sun & Moon" },
  { code: "CSMAC", name: "Sun & Moon Chinese: All-Stars A", era: "Sun & Moon" },
  { code: "CSMC", name: "Sun & Moon Chinese: Collection", era: "Sun & Moon" },
  { code: "CSMJC", name: "Sun & Moon Chinese: J", era: "Sun & Moon" },
  { code: "CSMLC", name: "Sun & Moon Chinese: L", era: "Sun & Moon" },
  { code: "CSMYC", name: "Sun & Moon Chinese: Y", era: "Sun & Moon" },
  { code: "CSFC", name: "Chinese Full Art Collection", era: "Chinese Collections" },
  { code: "CSGC", name: "Chinese Gold Collection", era: "Chinese Collections" },
  { code: "CSIC", name: "Chinese Illustration Collection", era: "Chinese Collections" },
  { code: "CSJC", name: "Chinese Jump Collection", era: "Chinese Collections" },
  { code: "CSUC", name: "Chinese Ultra Collection", era: "Chinese Collections" },
  { code: "CSXC", name: "Chinese X Collection", era: "Chinese Collections" },
  { code: "CSYC", name: "Chinese Y Collection", era: "Chinese Collections" },
  { code: "CSZC", name: "Chinese Z Collection", era: "Chinese Collections" },
