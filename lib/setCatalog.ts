...
export type SetCatalogLanguage = "fr" | "en" | "ja" | "zh-tw";

export function setIdAliases(
  idOrName?: string,
  language?: SetCatalogLanguage
): string[] {
  ...
  // "151" est un raccourci propre au catalogue japonais SV2a.
  // Il ne doit jamais ouvrir SV2a depuis les catalogues FR, EN ou CN.
  if (
    language === "ja" &&
    ["151", "pokemon151", "pokemoncard151"].includes(clean)
  ) {
    aliases.add("sv2a");
  }

  // Les codes chinois avec suffixes sont des extensions distinctes :
  // CSV2AC, CSV2BC, CSV5C... Aucun rabattement vers CSV2/CSV5.
