...
const JP: SetDisplayMeta[] = [
  ...
  { code: "FFL", name: "Future Flash", year: 2023, era: "Scarlet & Violet" },
  { code: "ANR", name: "Ancient Roar", year: 2023, era: "Scarlet & Violet" },
  ...
  { code: "VSU", name: "VSTAR Universe", year: 2022, era: "Sword & Shield" },
  { code: "PTG", name: "Paradigm Trigger", year: 2022, era: "Sword & Shield" },
  { code: "IAC", name: "Incandescent Arcana", year: 2022, era: "Sword & Shield" },
  { code: "LOR", name: "Lost Abyss", year: 2022, era: "Sword & Shield" },
  { code: "PGO", name: "Pokémon GO", year: 2022, era: "Sword & Shield" },
  { code: "DPT", name: "Dark Phantasma", year: 2022, era: "Sword & Shield" },
  { code: "SPJ", name: "Space Juggler", year: 2022, era: "Sword & Shield" },
  { code: "TMZ", name: "Time Gazer", year: 2022, era: "Sword & Shield" },
  { code: "BRG", name: "Battle Region", year: 2022, era: "Sword & Shield" },
  { code: "STB", name: "Star Birth", year: 2021, era: "Sword & Shield" },
  { code: "VMC", name: "VMAX Climax", year: 2021, era: "Sword & Shield" },
  { code: "25A", name: "25th Anniversary Collection", year: 2021, era: "Sword & Shield" },
  { code: "FST", name: "Fusion Strike", year: 2021, era: "Sword & Shield" },
  { code: "BSS", name: "Blue Sky Stream", year: 2021, era: "Sword & Shield" },
  { code: "SKP", name: "Skyscraping Perfection", year: 2021, era: "Sword & Shield" },
  { code: "EVH", name: "Eevee Heroes", year: 2021, era: "Sword & Shield" },
  { code: "JBS", name: "Jet-Black Spirit", year: 2021, era: "Sword & Shield" },
  { code: "SLL", name: "Silver Lance", year: 2021, era: "Sword & Shield" },
  { code: "PLF", name: "Peerless Fighters", year: 2021, era: "Sword & Shield" },
  { code: "RSM", name: "Rapid Strike Master", year: 2021, era: "Sword & Shield" },
  { code: "SSM", name: "Single Strike Master", year: 2021, era: "Sword & Shield" },
  { code: "SSV", name: "Shiny Star V", year: 2020, era: "Sword & Shield" },
  { code: "AVT", name: "Amazing Volt Tackle", year: 2020, era: "Sword & Shield" },
  { code: "IFZ", name: "Infinity Zone", year: 2020, era: "Sword & Shield" },
  { code: "RCL", name: "Rebellion Clash", year: 2020, era: "Sword & Shield" },
  { code: "SWS", name: "Sword & Shield", year: 2019, era: "Sword & Shield" },
  { code: "GUS", name: "GX Ultra Shiny", year: 2018, era: "Sun & Moon" },
  { code: "TGB", name: "Tag Bolt", year: 2018, era: "Sun & Moon" },
  { code: "DCL", name: "Darkness that Consumes Light", year: 2017, era: "Sun & Moon" },
  { code: "SLG", name: "Shining Legends", year: 2017, era: "Sun & Moon" },
  { code: "CLM", name: "Collection Moon", year: 2016, era: "Sun & Moon" },
  { code: "CLS", name: "Collection Sun", year: 2016, era: "Sun & Moon" },
  { code: "20A", name: "Expansion Pack 20th Anniversary", year: 2016, era: "XY" },
  { code: "APK", name: "Awakening Psychic King", year: 2016, era: "XY" },
  { code: "RBH", name: "Rage of the Broken Heavens", year: 2015, era: "XY" },
  { code: "BLS", name: "Blue Shock", year: 2015, era: "XY" },
  { code: "RDF", name: "Red Flash", year: 2015, era: "XY" },
  { code: "BDR", name: "Bandit Ring", year: 2015, era: "XY" },
  { code: "EMB", name: "Emerald Break", year: 2015, era: "XY" },
  { code: "DCR", name: "Double Crisis", year: 2015, era: "XY" },
  { code: "GVO", name: "Gaia Volcano", year: 2014, era: "XY" },
  { code: "TST", name: "Tidal Storm", year: 2014, era: "XY" },
  { code: "PTG", name: "Phantom Gate", year: 2014, era: "XY" },
  { code: "RSF", name: "Rising Fist", year: 2014, era: "XY" },
  { code: "WBL", name: "Wild Blaze", year: 2014, era: "XY" },
  { code: "CLX", name: "Collection X", year: 2013, era: "XY" },
  { code: "CLY", name: "Collection Y", year: 2013, era: "XY" },
  ...
  { code: "MFS", name: "Mirage Forest", year: 2005, era: "PCG" },
  { code: "GSS", name: "Golden Sky, Silvery Ocean", year: 2004, era: "PCG" },
  { code: "RGB", name: "Rocket Gang Strikes Back", year: 2004, era: "PCG" },
  { code: "CBS", name: "Clash of the Blue Sky", year: 2004, era: "ADV" },
  { code: "FOL", name: "Flight of Legends", year: 2004, era: "ADV" },
  { code: "RTH", name: "Rulers of the Heavens", year: 2004, era: "ADV" },
  { code: "MVA", name: "Magma VS Aqua: Two Ambitions", year: 2003, era: "ADV" },
  { code: "MOD", name: "Miracle of the Desert", year: 2003, era: "ADV" },
  { code: "ADV", name: "ADV Expansion Pack", year: 2003, era: "ADV" },
  { code: "MSM", name: "Mysterious Mountains", year: 2002, era: "e-Series" },
  { code: "SPE", name: "Split Earth", year: 2002, era: "e-Series" },
  { code: "WFS", name: "Wind from the Sea", year: 2002, era: "e-Series" },
  { code: "TNM", name: "The Town on No Map", year: 2002, era: "e-Series" },
  { code: "BEP", name: "Base Expansion Pack", year: 2001, era: "e-Series" },
  { code: "NDS", name: "Neo Destiny", year: 2000, era: "Neo" },
  { code: "NRE", name: "Neo Revelation", year: 2000, era: "Neo" },
  { code: "NDC", name: "Neo Discovery", year: 2000, era: "Neo" },
  { code: "NGS", name: "Neo Genesis", year: 1999, era: "Neo" },
  { code: "GCH", name: "Gym Challenge", year: 1998, era: "Original" },
  { code: "GHE", name: "Gym Heroes", year: 1998, era: "Original" },
  { code: "TRK", name: "Team Rocket", year: 1997, era: "Original" },
  { code: "FOS", name: "Fossile", year: 1997, era: "Original", aliases: ["Fossil"] },
  { code: "JUN", name: "Pokémon Jungle", year: 1997, era: "Original", aliases: ["Jungle"] },
  { code: "EXP", name: "Expansion Pack", year: 1996, era: "Original" },
];
...
const CN: SetDisplayMeta[] = [
  ...
  { code: "CSV9.5C", name: "Grand Terastal Gathering", year: 2026, era: "Simplified Chinese", sourceIds: ["csv9.5", "csv9.5c"], aliases: ["Terastal Gathering"] },
