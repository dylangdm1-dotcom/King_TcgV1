...
const JP: SetDisplayMeta[] = [
  ...
  { code: "MLC", name: "Megalo Cannon", year: 2013, era: "Black & White", sourceIds: ["BW9"] },
  { code: "PLG", name: "Plasma Gale", year: 2012, era: "Black & White", sourceIds: ["BW7"] },
  { code: "FRB", name: "Freeze Bolt", year: 2011, era: "Black & White", sourceIds: ["BW6B"] },
  { code: "CLF", name: "Cold Flare", year: 2011, era: "Black & White", sourceIds: ["BW6O"] },
  { code: "RDC", name: "Red Collection", year: 2010, era: "Black & White", sourceIds: ["BW2"] },
  { code: "BKC", name: "Black Collection", year: 2010, era: "Black & White", sourceIds: ["BW1B"] },
  { code: "WHC", name: "White Collection", year: 2010, era: "Black & White", sourceIds: ["BW1W"] },
  { code: "ADA", name: "Advent of Arceus", year: 2009, era: "Platinum", sourceIds: ["PT4"] },
  { code: "BOF", name: "Beat of the Frontier", year: 2009, era: "Platinum", sourceIds: ["PT3"] },
  { code: "GAC", name: "Galactic's Conquest", year: 2008, era: "Platinum", sourceIds: ["PT1"] },
  { code: "IFS", name: "Intense Fight in the Destroyed Sky", year: 2008, era: "Diamond & Pearl", sourceIds: ["DP6"] },
  { code: "SHD", name: "Shining Darkness", year: 2007, era: "Diamond & Pearl", sourceIds: ["DP3"] },
  { code: "SOT", name: "Secret of the Lakes", year: 2007, era: "Diamond & Pearl", sourceIds: ["DP2"] },
  { code: "STC", name: "Space-Time Creation", year: 2006, era: "Diamond & Pearl", sourceIds: ["DP1"] },
...
const CN: SetDisplayMeta[] = [
  { code: "CBB6C", name: "Gem Pack Volume 6", year: 2026, era: "Simplified Chinese", aliases: ["Gem Pack Vol. 6"] },
  { code: "CSV10C", name: "Chasing Glory Together", year: 2026, era: "Simplified Chinese", sourceIds: ["csv10c"] },
  { code: "CSV9.5C", name: "Grand Terastal Gathering", year: 2026, era: "Simplified Chinese", sourceIds: ["csv9.5c", "csv9.5", "csv95c", "csv95"], aliases: ["Terastal Gathering", "CSV95C"] },
  ...
  { code: "151C", name: "Collect 151", year: 2025, era: "Simplified Chinese", aliases: ["Collect 151 Gathering", "Collect 151 Surprise", "Collect 151 Hope", "Collect 151 Journey"] },
  ...
  { code: "CS5.5", name: "Shadow of Glory", year: 2024, era: "Simplified Chinese", sourceIds: ["CS55C"], aliases: ["Shadow of Glory"] },
  { code: "CS3.3", name: "Brave Stars", year: 2024, era: "Simplified Chinese", sourceIds: ["CS5BC", "CS5AC"], aliases: ["Brave Stars - Brave", "Brave Stars - Charm"] },
  { code: "CSV2.5", name: "Nine Colours Gathering", year: 2024, era: "Simplified Chinese", sourceIds: ["CS4BC", "CS4AC"], aliases: ["Nine Colors Gathering - Origin", "Nine Colors Gathering - Friends"] },
  ...
  { code: "CSV1C", name: "Vivid Portrayals", year: 2023, era: "Simplified Chinese", sourceIds: ["CS2BC", "CS2AC"], aliases: ["Vivid Portrayals Indigo", "Vivid Portrayals Obsidian"] },
  { code: "CS1B", name: "Shining Synergy", year: 2023, era: "Simplified Chinese", sourceIds: ["CSM2CC", "CSM2BC", "CSM2AC"], aliases: ["Shining Synergy Summon", "Shining Synergy Supreme", "Shining Synergy Shower"] },
  { code: "CS1.5", name: "Dynamax Tactics", year: 2023, era: "Simplified Chinese", sourceIds: ["CS1BC", "CS1AC"], aliases: ["Dynamax Clash Flame", "Dynamax Clash Thunder"] },
  { code: "CSM1", name: "Storming Emergence", year: 2022, era: "Simplified Chinese", sourceIds: ["CSM1CC", "CSM1BC", "CSM1AC"], aliases: ["Storming Emergence Abundant", "Storming Emergence Verdant", "Storming Emergence Radiant"] },
];
...
export function getSetDisplayMeta(
  ...
  // JP / CN: classify only from an exact provider/source ID.
  // Names are not stable enough across regional providers (reused names,
  // split products, anniversary/movie sets). A name-only match could move a
  // real provider row out of "À trier" even when its technical identity is
  // still unknown. Keeping unknown IDs unclassified is deliberately
  // non-destructive: the set stays visible and clickable with its provider ID.
  ...
  if (lang === "ja" || lang === "zh-tw") return undefined;

  // FR keeps name/alias matching because its catalogue display layer is
  // already validated and the provider identifiers are not always the public
  // French codes.
